...
<figure class="lec-fig"><svg viewBox="0 0 600 300" role="img" aria-label="混同行列をクラスcに注目してone-vs-restに分解。対角C[c,c]がTP、列cの残りがFP、行cの残りがFN、それ以外がTN" font-family="ui-sans-serif, system-ui, 'Noto Sans JP', sans-serif"><text x="250" y="38" text-anchor="middle" font-size="14" fill="#2563eb">予測 j（列）→</text><text x="120" y="160" text-anchor="middle" font-size="14" fill="#c2410c" style="writing-mode:vertical-rl;text-orientation:upright">正解 i（行）↓</text><rect x="150" y="60" width="50" height="50" fill="#f4f4f5" stroke="#ffffff" stroke-width="2"/><rect x="200" y="60" width="50" height="50" fill="#2563eb" stroke="#ffffff" stroke-width="2"/><rect x="250" y="60" width="50" height="50" fill="#f4f4f5" stroke="#ffffff" stroke-width="2"/><rect x="300" y="60" width="50" height="50" fill="#f4f4f5" stroke="#ffffff" stroke-width="2"/><rect x="150" y="110" width="50" height="50" fill="#16a34a" stroke="#ffffff" stroke-width="2"/><rect x="200" y="110" width="50" height="50" fill="#ea580c" stroke="#ffffff" stroke-width="2"/><rect x="250" y="110" width="50" height="50" fill="#16a34a" stroke="#ffffff" stroke-width="2"/><rect x="300" y="110" width="50" height="50" fill="#16a34a" stroke="#ffffff" stroke-width="2"/><rect x="150" y="160" width="50" height="50" fill="#f4f4f5" stroke="#ffffff" stroke-width="2"/><rect x="200" y="160" width="50" height="50" fill="#2563eb" stroke="#ffffff" stroke-width="2"/><rect x="250" y="160" width="50" height="50" fill="#f4f4f5" stroke="#ffffff" stroke-width="2"/><rect x="300" y="160" width="50" height="50" fill="#f4f4f5" stroke="#ffffff" stroke-width="2"/><rect x="150" y="210" width="50" height="50" fill="#f4f4f5" stroke="#ffffff" stroke-width="2"/><rect x="200" y="210" width="50" height="50" fill="#2563eb" stroke="#ffffff" stroke-width="2"/><rect x="250" y="210" width="50" height="50" fill="#f4f4f5" stroke="#ffffff" stroke-width="2"/><rect x="300" y="210" width="50" height="50" fill="#f4f4f5" stroke="#ffffff" stroke-width="2"/><rect x="150" y="60" width="200" height="200" fill="none" stroke="#71717a" stroke-width="1.5"/><text x="225" y="140" text-anchor="middle" font-size="15" font-weight="700" fill="#ffffff">TP</text><rect x="385" y="80" width="20" height="20" fill="#ea580c"/><text x="415" y="95" font-size="13" fill="#18181b">TP：対角 C[c,c]</text><rect x="385" y="125" width="20" height="20" fill="#2563eb"/><text x="415" y="140" font-size="13" fill="#18181b">FP：列 c（予測=c）</text><rect x="385" y="170" width="20" height="20" fill="#16a34a"/><text x="415" y="185" font-size="13" fill="#18181b">FN：行 c（正解=c）</text><rect x="385" y="215" width="20" height="20" fill="#f4f4f5" stroke="#d4d4d8"/><text x="415" y="230" font-size="13" fill="#18181b">TN：それ以外</text></svg><figcaption>多クラスの<b>混同行列</b>を「クラス c か否か」の二値問題に分解（<b>one-vs-rest</b>）した図です。<b>行＝正解 i・列＝予測 j</b> の向きで、対角 <code>C[c,c]</code> が <b>TP</b>、<b>列 c</b> の対角以外の合計が <b>FP</b>、<b>行 c</b> の対角以外の合計が <b>FN</b>、残り全部が <b>TN</b>。「FP は列・FN は行」をここで手に焼き付けてください。</figcaption></figure>
...
<figure class="lec-fig"><svg viewBox="0 0 600 300" role="img" aria-label="予測=陽性の枠と実際=陽性の枠の重なりがTP。予測のみがFP、実際のみがFN。precisionは予測枠に対するTPの割合、recallは実際枠に対するTPの割合" font-family="ui-sans-serif, system-ui, 'Noto Sans JP', sans-serif"><rect x="120" y="110" width="160" height="90" fill="#dbeafe"/><rect x="280" y="110" width="60" height="90" fill="#ea580c"/><rect x="340" y="110" width="160" height="90" fill="#ffedd5"/><rect x="120" y="110" width="220" height="90" fill="none" stroke="#2563eb" stroke-width="3"/><rect x="280" y="110" width="220" height="90" fill="none" stroke="#ea580c" stroke-width="3"/><text x="200" y="165" text-anchor="middle" font-size="16" font-weight="700" fill="#1d4ed8">FP</text><text x="310" y="165" text-anchor="middle" font-size="15" font-weight="700" fill="#ffffff">TP</text><text x="420" y="165" text-anchor="middle" font-size="16" font-weight="700" fill="#c2410c">FN</text><polyline points="120,104 120,94 340,94 340,104" fill="none" stroke="#2563eb" stroke-width="2"/><text x="230" y="84" text-anchor="middle" font-size="13" font-weight="700" fill="#1d4ed8">予測＝陽性：precision の分母 (TP+FP)</text><polyline points="280,206 280,216 500,216 500,206" fill="none" stroke="#ea580c" stroke-width="2"/><text x="390" y="236" text-anchor="middle" font-size="13" font-weight="700" fill="#c2410c">実際＝陽性：recall の分母 (TP+FN)</text><text x="300" y="275" text-anchor="middle" font-size="12.5" fill="#52525b">枠の外側はすべて TN（陰性を正しく陰性と判定）</text></svg><figcaption><b>precision</b> と <b>recall</b> の違いを集合で見る図です。<b>青枠＝予測が陽性</b>、<b>橙枠＝実際に陽性</b>で、重なりが <b>TP</b>。<code>precision = TP/(TP+FP)</code> は<b>青枠</b>のうち当たった割合、<code>recall = TP/(TP+FN)</code> は<b>橙枠</b>のうち拾えた割合です。しきい値を下げると青枠が広がり recall↑・precision↓、というトレードオフが見えます。</figcaption></figure>
...
<figure class="lec-fig"><svg viewBox="0 0 560 320" role="img" aria-label="ROC曲線。横軸FPR縦軸TPRで、しきい値を高から低へ下げて(0,0)から(1,1)へ描く。曲線下の面積がROC-AUC、対角線はランダム=0.5" font-family="ui-sans-serif, system-ui, 'Noto Sans JP', sans-serif"><path d="M 90,270 L 109,171 L 128,134 L 166,98 L 223,76 L 280,65 L 356,57 L 470,50 L 470,270 Z" fill="#ffedd5"/><line x1="90" y1="270" x2="470" y2="50" stroke="#71717a" stroke-width="2" stroke-dasharray="6 5"/><polyline points="90,270 109,171 128,134 166,98 223,76 280,65 356,57 470,50" fill="none" stroke="#ea580c" stroke-width="3"/><line x1="90" y1="270" x2="480" y2="270" stroke="#3f3f46" stroke-width="1.5"/><polygon points="486,270 478,266 478,274" fill="#3f3f46"/><line x1="90" y1="270" x2="90" y2="44" stroke="#3f3f46" stroke-width="1.5"/><polygon points="90,38 86,46 94,46" fill="#3f3f46"/><text x="285" y="302" text-anchor="middle" font-size="13" fill="#3f3f46">FPR = FP/(FP+TN) →</text><text x="40" y="160" text-anchor="middle" font-size="13" fill="#3f3f46" transform="rotate(-90 40 160)">TPR = recall ↑</text><text x="300" y="200" text-anchor="middle" font-size="20" font-weight="700" fill="#c2410c">AUC</text><text x="188" y="208" text-anchor="middle" font-size="12" fill="#71717a" transform="rotate(-30 188 208)">ランダム = 0.5</text><text x="86" y="286" font-size="11" fill="#71717a">0</text><text x="470" y="286" text-anchor="middle" font-size="11" fill="#71717a">1.0</text><text x="78" y="54" text-anchor="end" font-size="11" fill="#71717a">1.0</text></svg><figcaption><b>ROC 曲線</b>です。しきい値を高い方から下げながら、横軸 <b>FPR</b>=<code>FP/(FP+TN)</code>・縦軸 <b>TPR</b>=<code>recall</code> を打点し、(0,0)→(1,1) を結びます。<b>曲線の下の面積が ROC-AUC</b>（橙の領域）で、対角の点線＝ランダム（0.5）。AUC は「陽性のスコアが陰性より高い確率」＝<b>順位の指標</b>で、スコアを単調変換しても不変です。</figcaption></figure>
...
<figure class="lec-fig"><svg viewBox="0 0 560 320" role="img" aria-label="PR曲線。横軸recall縦軸precision。曲線下の面積がAP。無情報な分類器のベースラインは陽性割合に一致し、不均衡では0.10と低く均衡では0.51と高い" font-family="ui-sans-serif, system-ui, 'Noto Sans JP', sans-serif"><path d="M 90,50 L 128,61 L 204,83 L 280,112 L 356,149 L 413,182 L 470,226 L 470,270 L 90,270 Z" fill="#ffedd5"/><polyline points="90,50 128,61 204,83 280,112 356,149 413,182 470,226" fill="none" stroke="#ea580c" stroke-width="3"/><line x1="90" y1="158" x2="470" y2="158" stroke="#2563eb" stroke-width="2" stroke-dasharray="6 5"/><line x1="90" y1="248" x2="470" y2="248" stroke="#dc2626" stroke-width="2" stroke-dasharray="6 5"/><line x1="90" y1="270" x2="480" y2="270" stroke="#3f3f46" stroke-width="1.5"/><polygon points="486,270 478,266 478,274" fill="#3f3f46"/><line x1="90" y1="270" x2="90" y2="44" stroke="#3f3f46" stroke-width="1.5"/><polygon points="90,38 86,46 94,46" fill="#3f3f46"/><text x="285" y="302" text-anchor="middle" font-size="13" fill="#3f3f46">recall →</text><text x="40" y="160" text-anchor="middle" font-size="13" fill="#3f3f46" transform="rotate(-90 40 160)">precision ↑</text><text x="180" y="135" text-anchor="middle" font-size="18" font-weight="700" fill="#c2410c">AP</text><text x="298" y="152" font-size="12" fill="#1d4ed8">均衡 baseline ≈ 0.51</text><text x="300" y="242" font-size="12" fill="#dc2626">不均衡 baseline ≈ 0.10</text></svg><figcaption><b>PR 曲線</b>です。横軸 <b>recall</b>・縦軸 <b>precision</b> で、<b>曲線の下の面積が AP</b>（＝PR-AUC、橙の領域）。無情報な分類器の<b>ベースラインは陽性割合そのもの</b>で、<b>不均衡（≈0.10）では低く、均衡（≈0.51）では高い</b>位置に動きます。ROC-AUC が不均衡に鈍感なのに対し、AP はこのベースラインを通じて prevalence を直接映すのが要点です。</figcaption></figure>
...
<figure class="lec-fig"><svg viewBox="0 0 660 300" role="img" aria-label="しきい値掃引のパイプライン。スコア降順ソート、TP/FP累積、各点を打点まで共通で、最後にROCは台形則でAUC、PRはステップ和でAPと面積の取り方だけ分岐する" font-family="ui-sans-serif, system-ui, 'Noto Sans JP', sans-serif"><text x="300" y="26" text-anchor="middle" font-size="12.5" fill="#71717a">ROC と PR は同じ掃引手順、最後の面積の取り方だけ違う</text><rect x="14" y="122" width="120" height="64" rx="8" fill="#fff7ed" stroke="#ea580c" stroke-width="2.5"/><text x="74" y="150" text-anchor="middle" font-size="13" font-weight="700" fill="#c2410c">① 降順ソート</text><text x="74" y="170" text-anchor="middle" font-size="11" fill="#52525b">argsort(-score)</text><rect x="164" y="122" width="120" height="64" rx="8" fill="#fff7ed" stroke="#ea580c" stroke-width="2.5"/><text x="224" y="150" text-anchor="middle" font-size="13" font-weight="700" fill="#c2410c">② TP/FP 累積</text><text x="224" y="170" text-anchor="middle" font-size="11" fill="#52525b">cumsum</text><rect x="314" y="122" width="120" height="64" rx="8" fill="#fff7ed" stroke="#ea580c" stroke-width="2.5"/><text x="374" y="150" text-anchor="middle" font-size="13" font-weight="700" fill="#c2410c">③ 各点を打点</text><text x="374" y="170" text-anchor="middle" font-size="11" fill="#52525b">しきい値を下げつつ</text><rect x="486" y="56" width="160" height="64" rx="8" fill="#dbeafe" stroke="#2563eb" stroke-width="2.5"/><text x="566" y="84" text-anchor="middle" font-size="14" font-weight="700" fill="#1d4ed8">ROC-AUC</text><text x="566" y="105" text-anchor="middle" font-size="11" fill="#52525b">台形則で面積</text><rect x="486" y="190" width="160" height="64" rx="8" fill="#ffedd5" stroke="#c2410c" stroke-width="2.5"/><text x="566" y="218" text-anchor="middle" font-size="13.5" font-weight="700" fill="#c2410c">AP（PR-AUC）</text><text x="566" y="239" text-anchor="middle" font-size="11" fill="#52525b">ステップ和で面積</text><line x1="134" y1="154" x2="154" y2="154" stroke="#71717a" stroke-width="2"/><polygon points="164,154 154,149 154,159" fill="#71717a"/><line x1="284" y1="154" x2="304" y2="154" stroke="#71717a" stroke-width="2"/><polygon points="314,154 304,149 304,159" fill="#71717a"/><line x1="434" y1="154" x2="480" y2="96" stroke="#71717a" stroke-width="2"/><polygon points="486,88 483.74,98.96 475.88,92.77" fill="#71717a"/><line x1="434" y1="154" x2="480" y2="214" stroke="#71717a" stroke-width="2"/><polygon points="486,222 475.96,217.10 483.90,211.02" fill="#71717a"/></svg><figcaption><b>しきい値掃引</b>で「曲線 → 面積」を出すパイプラインです。<b>① スコアを降順ソート</b>（＝しきい値を高→低に下げる）→ <b>② TP/FP を累積</b>（<code>cumsum</code>）→ <b>③ 各しきい値で打点</b>、までは ROC も PR も<b>共通</b>です。違うのは<b>最後の面積の取り方</b>だけで、<b>ROC は (FPR, TPR) を台形則</b>で積んで <b>ROC-AUC</b>、<b>PR は (recall, precision) をステップ和</b>で積んで <b>AP（PR-AUC）</b> になります。</figcaption></figure>
...
<figure class="lec-fig"><svg viewBox="0 0 640 300" role="img" aria-label="torchmetricsのupdate-compute-resetサイクル。複数バッチをupdateで内部状態に累積しcomputeで確定、resetで状態を空にする" font-family="ui-sans-serif, system-ui, 'Noto Sans JP', sans-serif"><rect x="20" y="50" width="92" height="40" rx="6" fill="#dbeafe" stroke="#2563eb" stroke-width="2"/><text x="66" y="75" text-anchor="middle" font-size="14" font-weight="700" fill="#1d4ed8">batch 1</text><rect x="20" y="158" width="92" height="40" rx="6" fill="#dbeafe" stroke="#2563eb" stroke-width="2"/><text x="66" y="183" text-anchor="middle" font-size="14" font-weight="700" fill="#1d4ed8">batch 2</text><line x1="112" y1="70" x2="167" y2="106" stroke="#52525b" stroke-width="2"/><polygon points="175,112 163.9,110.6 169.5,102.3" fill="#52525b"/><line x1="112" y1="178" x2="167" y2="141" stroke="#52525b" stroke-width="2"/><polygon points="175,136 169.5,145.7 163.9,137.4" fill="#52525b"/><rect x="175" y="94" width="110" height="60" rx="8" fill="#fff7ed" stroke="#ea580c" stroke-width="2.5"/><text x="230" y="130" text-anchor="middle" font-size="16" font-weight="700" fill="#c2410c">update()</text><line x1="285" y1="124" x2="326" y2="124" stroke="#52525b" stroke-width="2"/><polygon points="330,124 320,119 320,129" fill="#52525b"/><rect x="330" y="94" width="130" height="60" rx="8" fill="#ffedd5" stroke="#c2410c" stroke-width="2.5"/><text x="395" y="130" text-anchor="middle" font-size="15" font-weight="700" fill="#c2410c">状態を累積</text><line x1="460" y1="124" x2="501" y2="124" stroke="#52525b" stroke-width="2"/><polygon points="505,124 495,119 495,129" fill="#52525b"/><rect x="505" y="94" width="110" height="60" rx="8" fill="#fff7ed" stroke="#ea580c" stroke-width="2.5"/><text x="560" y="130" text-anchor="middle" font-size="16" font-weight="700" fill="#c2410c">compute()</text><line x1="560" y1="154" x2="560" y2="196" stroke="#52525b" stroke-width="2"/><polygon points="560,200 555,190 565,190" fill="#52525b"/><rect x="505" y="200" width="110" height="44" rx="8" fill="#f4f4f5" stroke="#16a34a" stroke-width="2"/><text x="560" y="227" text-anchor="middle" font-size="14" font-weight="700" fill="#15803d">確定値</text><path d="M 560,94 C 540,40 415,40 395,90" fill="none" stroke="#16a34a" stroke-width="2" stroke-dasharray="5 4"/><polygon points="395,94 389,84 401,84" fill="#16a34a"/><text x="478" y="32" text-anchor="middle" font-size="13" font-weight="700" fill="#15803d">reset() で状態を空に</text></svg><figcaption><b>torchmetrics</b> の <code>update → compute → reset</code> サイクルです。ミニバッチごとに <b>update()</b> で内部状態（TP/FP… のカウント）へ足し込み、エポック末に <b>compute()</b> で<b>確定値</b>を出します（2 バッチに分けても全件一括計算と一致）。次のエポックの前に <b>reset()</b> で状態を空にしないと、前エポックの統計が混ざり続けます。</figcaption></figure>
...
<figure class="lec-fig"><svg viewBox="0 0 680 340" role="img" aria-label="ミニプロジェクトの評価パイプライン。合成データから3つの分析（モデル選択・しきい値最適化・ブートストラップCI）を経て6パネルのダッシュボードとJSONを出力する" font-family="ui-sans-serif, system-ui, 'Noto Sans JP', sans-serif"><text x="352" y="26" text-anchor="middle" font-size="12" fill="#71717a">同じ評価セット上で 3 つの分析を並行</text><rect x="24" y="143" width="128" height="60" rx="8" fill="#dbeafe" stroke="#2563eb" stroke-width="2.5"/><text x="88" y="169" text-anchor="middle" font-size="14.5" font-weight="700" fill="#1d4ed8">合成データ</text><text x="88" y="190" text-anchor="middle" font-size="11.5" fill="#1d4ed8">(y_true, proba)</text><rect x="262" y="44" width="180" height="58" rx="8" fill="#fff7ed" stroke="#ea580c" stroke-width="2.5"/><text x="352" y="68" text-anchor="middle" font-size="14" font-weight="700" fill="#c2410c">① モデル選択</text><text x="352" y="88" text-anchor="middle" font-size="11" fill="#52525b">accuracy vs macro-F1/AP</text><rect x="262" y="144" width="180" height="58" rx="8" fill="#fff7ed" stroke="#ea580c" stroke-width="2.5"/><text x="352" y="168" text-anchor="middle" font-size="14" font-weight="700" fill="#c2410c">② しきい値最適化</text><text x="352" y="188" text-anchor="middle" font-size="11" fill="#52525b">F1最大 / Youden-J</text><rect x="262" y="244" width="180" height="58" rx="8" fill="#fff7ed" stroke="#ea580c" stroke-width="2.5"/><text x="352" y="268" text-anchor="middle" font-size="14" font-weight="700" fill="#c2410c">③ ブートストラップCI</text><text x="352" y="288" text-anchor="middle" font-size="11" fill="#52525b">macro-F1 ×500 → 95%CI</text><rect x="540" y="139" width="120" height="68" rx="8" fill="#f4f4f5" stroke="#16a34a" stroke-width="2.5"/><text x="600" y="164" text-anchor="middle" font-size="13.5" font-weight="700" fill="#15803d">6パネル</text><text x="600" y="183" text-anchor="middle" font-size="12" font-weight="700" fill="#15803d">ダッシュボード</text><text x="600" y="200" text-anchor="middle" font-size="11.5" fill="#52525b">+ JSON</text><line x1="152" y1="173" x2="255" y2="80" stroke="#71717a" stroke-width="2"/><polygon points="262,73 257.96,83.43 251.24,76.03" fill="#71717a"/><line x1="152" y1="173" x2="252" y2="173" stroke="#71717a" stroke-width="2"/><polygon points="262,173 252,168 252,178" fill="#71717a"/><line x1="152" y1="173" x2="255" y2="266" stroke="#71717a" stroke-width="2"/><polygon points="262,273 251.24,269.97 257.96,262.57" fill="#71717a"/><line x1="442" y1="73" x2="532" y2="150" stroke="#71717a" stroke-width="2"/><polygon points="540,157 529.16,154.29 535.66,146.70" fill="#71717a"/><line x1="442" y1="173" x2="530" y2="173" stroke="#71717a" stroke-width="2"/><polygon points="540,173 530,168 530,178" fill="#71717a"/><line x1="442" y1="273" x2="532" y2="196" stroke="#71717a" stroke-width="2"/><polygon points="540,189 535.66,199.31 529.16,191.71" fill="#71717a"/></svg><figcaption><b>章末ミニプロジェクト</b>の評価パイプラインです。1 つの<b>合成評価セット</b>（<code>y_true, proba</code>）を入口に、<b>① モデル選択</b>（accuracy の罠を macro-F1/AP で回避）・<b>② しきい値最適化</b>（F1 最大点と Youden-J 点は一致しない）・<b>③ ブートストラップ信頼区間</b>（<code>macro-F1</code> を 500 回で 95%CI）の 3 分析を<b>同じ評価セット上で並行</b>に回し、最後に <b>6 パネルのダッシュボード</b>＋<code>JSON</code> に束ねます。</figcaption></figure>
