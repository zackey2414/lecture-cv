...
<figure class="lec-fig"><svg viewBox="0 0 640 320" role="img" aria-label="ONNX Runtimeをランタイムとして使う流れ。PyTorchモデルをtorch.onnx.exportでonnxに書き出しSessionOptionsで最適化してInferenceSessionで推論し、quantize_dynamicでint8の別グラフも得る" font-family="ui-sans-serif, system-ui, 'Noto Sans JP', sans-serif"><text x="320" y="34" text-anchor="middle" font-size="14" font-weight="700" fill="#18181b">PyTorch → ONNX → ONNX Runtime 推論</text><rect x="16" y="80" width="120" height="62" rx="8" fill="#eff6ff" stroke="#2563eb" stroke-width="2"/><rect x="260" y="80" width="120" height="62" rx="8" fill="#fff7ed" stroke="#ea580c" stroke-width="2"/><rect x="496" y="80" width="128" height="62" rx="8" fill="#eff6ff" stroke="#2563eb" stroke-width="2"/><rect x="260" y="216" width="120" height="62" rx="8" fill="#ffffff" stroke="#16a34a" stroke-width="2"/><text x="76" y="106" text-anchor="middle" font-size="15" font-weight="700" fill="#1d4ed8">PyTorch</text><text x="76" y="126" text-anchor="middle" font-size="11" fill="#71717a">resnet18</text><text x="320" y="106" text-anchor="middle" font-size="15" font-weight="700" fill="#c2410c">.onnx</text><text x="320" y="126" text-anchor="middle" font-size="11" fill="#71717a">fp32 グラフ</text><text x="560" y="104" text-anchor="middle" font-size="15" font-weight="700" fill="#1d4ed8">ORT 推論</text><text x="560" y="124" text-anchor="middle" font-size="11" fill="#71717a">sess.run → logits</text><text x="320" y="242" text-anchor="middle" font-size="15" font-weight="700" fill="#15803d">.onnx (int8)</text><text x="320" y="262" text-anchor="middle" font-size="11" fill="#71717a">≈ 1/4 サイズ</text><line x1="136" y1="111" x2="254" y2="111" stroke="#71717a" stroke-width="2"/><polygon points="260,111 250,106 250,116" fill="#71717a"/><text x="198" y="95" text-anchor="middle" font-size="11.5" fill="#3f3f46">torch.onnx.export</text><text x="198" y="131" text-anchor="middle" font-size="10.5" fill="#71717a">dynamo=False · opset17</text><line x1="380" y1="111" x2="490" y2="111" stroke="#71717a" stroke-width="2"/><polygon points="496,111 486,106 486,116" fill="#71717a"/><text x="438" y="95" text-anchor="middle" font-size="11.5" fill="#3f3f46">SessionOptions</text><text x="438" y="131" text-anchor="middle" font-size="10.5" fill="#71717a">ORT_ENABLE_ALL</text><line x1="320" y1="142" x2="320" y2="210" stroke="#71717a" stroke-width="2"/><polygon points="320,216 315,206 325,206" fill="#71717a"/><text x="332" y="168" font-size="11" fill="#3f3f46">quantize_dynamic</text><text x="332" y="184" font-size="10.5" fill="#71717a">QUInt8</text></svg><figcaption><b>ONNX Runtime をランタイムとして使う</b>流れです。<b>PyTorch モデル</b>を <code>torch.onnx.export(dynamo=False, opset_version=17)</code> で <b>.onnx（fp32）</b>に書き出し、<code>SessionOptions</code> の <b>ORT_ENABLE_ALL</b>（演算子融合・定数畳み込み）とスレッド数を設定して <code>InferenceSession.run</code> で推論します。<code>quantize_dynamic(QUInt8)</code> を挟めば <b>int8（約 1/4 サイズ）</b>の別グラフが得られ、同じ手順でロードできます。<b>変換した瞬間に速くなったと思い込まず、必ず eager との数値一致</b>を確かめます。</figcaption></figure>
...
<figure class="lec-fig"><svg viewBox="0 0 660 330" role="img" aria-label="章末ミニプロジェクトの流れ。resnet18を複数ランタイムへ変換し共通インタフェースに揃え4軸で横並び比較し用途別に意思決定してレポートと図を出力する" font-family="ui-sans-serif, system-ui, 'Noto Sans JP', sans-serif"><text x="330" y="32" text-anchor="middle" font-size="14" font-weight="700" fill="#18181b">マルチランタイム・ベンチ ＆ 意思決定の一気通貫</text><rect x="24" y="64" width="180" height="64" rx="8" fill="#eff6ff" stroke="#2563eb" stroke-width="2"/><rect x="240" y="64" width="180" height="64" rx="8" fill="#fff7ed" stroke="#ea580c" stroke-width="2"/><rect x="456" y="64" width="180" height="64" rx="8" fill="#fff7ed" stroke="#ea580c" stroke-width="2"/><rect x="456" y="214" width="180" height="64" rx="8" fill="#fff7ed" stroke="#ea580c" stroke-width="2"/><rect x="240" y="214" width="180" height="64" rx="8" fill="#fff7ed" stroke="#ea580c" stroke-width="2"/><rect x="24" y="214" width="180" height="64" rx="8" fill="#eff6ff" stroke="#2563eb" stroke-width="2"/><text x="114" y="92" text-anchor="middle" font-size="15" font-weight="700" fill="#1d4ed8">resnet18</text><text x="114" y="112" text-anchor="middle" font-size="11" fill="#71717a">1 つのモデル</text><text x="330" y="92" text-anchor="middle" font-size="15" font-weight="700" fill="#c2410c">複数ランタイムへ変換</text><text x="330" y="112" text-anchor="middle" font-size="11" fill="#71717a">eager / TS / ONNX / …</text><text x="546" y="92" text-anchor="middle" font-size="15" font-weight="700" fill="#c2410c">共通インタフェース</text><text x="546" y="112" text-anchor="middle" font-size="11" fill="#71717a">numpy in → logits out</text><text x="546" y="242" text-anchor="middle" font-size="15" font-weight="700" fill="#c2410c">4 軸で横並び比較</text><text x="546" y="262" text-anchor="middle" font-size="11" fill="#71717a">速度 / サイズ / 精度</text><text x="330" y="242" text-anchor="middle" font-size="15" font-weight="700" fill="#c2410c">用途別に意思決定</text><text x="330" y="262" text-anchor="middle" font-size="11" fill="#71717a">①最速 ②最小 ③推奨</text><text x="114" y="242" text-anchor="middle" font-size="15" font-weight="700" fill="#1d4ed8">レポート ＋ 図を出力</text><text x="114" y="262" text-anchor="middle" font-size="11" fill="#71717a">report.md / bench.png</text><line x1="204" y1="96" x2="234" y2="96" stroke="#71717a" stroke-width="2"/><polygon points="240,96 230,91 230,101" fill="#71717a"/><line x1="420" y1="96" x2="450" y2="96" stroke="#71717a" stroke-width="2"/><polygon points="456,96 446,91 446,101" fill="#71717a"/><line x1="546" y1="128" x2="546" y2="208" stroke="#71717a" stroke-width="2"/><polygon points="546,214 541,204 551,204" fill="#71717a"/><line x1="456" y1="246" x2="426" y2="246" stroke="#71717a" stroke-width="2"/><polygon points="420,246 430,241 430,251" fill="#71717a"/><line x1="240" y1="246" x2="210" y2="246" stroke="#71717a" stroke-width="2"/><polygon points="204,246 214,241 214,251" fill="#71717a"/></svg><figcaption><b>章末ミニプロジェクト</b>は、<code>resnet18</code> 1 つを <b>複数ランタイムへ変換</b>（eager / TorchScript / ONNX / OpenVINO 等）し、<b>共通インタフェース</b>（numpy in → logits out）に揃えてから、<b>4 軸</b>（レイテンシ・スループット・サイズ・精度保持）で横並び比較します。続けて <b>用途別に意思決定</b>（最速・最小・総合おすすめ）し、<b>レポート（md）と図（png）を出力</b>する一気通貫です。共通 I/F に揃えるからこそ <b>1 つのループで公平に比較</b>でき、結論を<b>根拠つき</b>で選べます。</figcaption></figure>
