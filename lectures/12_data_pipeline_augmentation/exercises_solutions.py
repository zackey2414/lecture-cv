"""第12回 演習の模範解答（このファイルを実行すると全10問 PASS する）。
...
実行: uv run python lectures/12_data_pipeline_augmentation/exercises_solutions.py
  → "10/10 問 PASS" / "ALL PASS 🎉" が出れば、教材の解答が現行版で正しいことの確認。
"""
