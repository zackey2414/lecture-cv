...
到達点を一言でいえば、**サンプル画像も GPU も無い環境で、複数枚を順次つなぐパノラマ合成パイプラインを一人で書き、その精度を再投影誤差とインライア比で説明でき、さらに高レベル API の `cv2.Stitcher` が中で何を自動化しているかを理解した上で使い分けられる**ことです。まず手作りで仕組みを完全に見通し、そのうえで自動化と比べる——この順序をたどるからこそ、ブラックボックスに頼らずに済む地力がつきます。本章で組み立てる手作りパイプラインの全体像を、まず下の図で俯瞰しておきましょう。

<figure class="lec-fig"><svg viewBox="0 0 660 130" role="img" aria-label="手作りパノラマの全体パイプライン。特徴マッチからH推定・品質検証・キャンバス計算・warp・フェザー合成の順で1枚に合成する流れ" font-family="ui-sans-serif, system-ui, 'Noto Sans JP', sans-serif"><text x="330" y="22" text-anchor="middle" font-size="14" font-weight="700" fill="#18181b">手作りパノラマ・パイプラインの全体像</text><rect x="14" y="42" width="112" height="66" rx="6" fill="#eff6ff" stroke="#2563eb" stroke-width="2"/><text x="70" y="73" text-anchor="middle" font-size="12.5" font-weight="700" fill="#1d4ed8">1. 特徴マッチ</text><text x="70" y="94" text-anchor="middle" font-size="10.5" fill="#52525b">ORB＋比率テスト</text><line x1="126" y1="75" x2="142" y2="75" stroke="#71717a" stroke-width="2"/><polygon points="146,75 136,70 136,80" fill="#71717a"/><rect x="146" y="42" width="112" height="66" rx="6" fill="#fff7ed" stroke="#f97316" stroke-width="2"/><text x="202" y="73" text-anchor="middle" font-size="12.5" font-weight="700" fill="#c2410c">2. H 推定</text><text x="202" y="94" text-anchor="middle" font-size="10.5" fill="#52525b">RANSAC で推定</text><line x1="258" y1="75" x2="274" y2="75" stroke="#71717a" stroke-width="2"/><polygon points="278,75 268,70 268,80" fill="#71717a"/><rect x="278" y="42" width="112" height="66" rx="6" fill="#fff7ed" stroke="#f97316" stroke-width="2"/><text x="334" y="73" text-anchor="middle" font-size="12.5" font-weight="700" fill="#c2410c">3. 品質検証</text><text x="334" y="94" text-anchor="middle" font-size="10.5" fill="#52525b">再投影誤差/比</text><line x1="390" y1="75" x2="406" y2="75" stroke="#71717a" stroke-width="2"/><polygon points="410,75 400,70 400,80" fill="#71717a"/><rect x="410" y="42" width="112" height="66" rx="6" fill="#fff7ed" stroke="#f97316" stroke-width="2"/><text x="466" y="73" text-anchor="middle" font-size="12.5" font-weight="700" fill="#c2410c">4. キャンバス</text><text x="466" y="94" text-anchor="middle" font-size="10.5" fill="#52525b">T@H で warp</text><line x1="522" y1="75" x2="538" y2="75" stroke="#71717a" stroke-width="2"/><polygon points="542,75 532,70 532,80" fill="#71717a"/><rect x="542" y="42" width="112" height="66" rx="6" fill="#fff7ed" stroke="#f97316" stroke-width="2"/><text x="598" y="73" text-anchor="middle" font-size="12.5" font-weight="700" fill="#c2410c">5. フェザー合成</text><text x="598" y="94" text-anchor="middle" font-size="10.5" fill="#52525b">加重平均で合成</text></svg><figcaption>本章で組み立てる<b>手作りパノラマ・パイプライン</b>の全体像です。<b>特徴マッチ</b>（前回・第5回の ORB＋比率テスト）で対応点を得て、<b>findHomography＋RANSAC</b> で <code>H</code> を推定し、<b>再投影誤差・インライア比</b>で品質を検証、四隅から<b>キャンバスと平行移動 T</b> を決めて <code>T@H</code> で warp し、最後に<b>フェザー（加重平均）</b>で重なりを溶かして 1 枚にします。3 枚以上なら推定を隣接ペアで繰り返し、行列を掛け合わせて基準フレームへそろえます。</figcaption></figure>
...
<figure class="lec-fig"><svg viewBox="0 0 660 130" role="img" aria-label="ミニプロジェクトの5段パイプライン。4視点合成→手作りパノラマ→Stitcher比較→平面物体のまっすぐ化→レポート化の順" font-family="ui-sans-serif, system-ui, 'Noto Sans JP', sans-serif"><text x="330" y="22" text-anchor="middle" font-size="14" font-weight="700" fill="#18181b">ミニプロジェクトの 5 段パイプライン</text><rect x="14" y="42" width="112" height="66" rx="6" fill="#fff7ed" stroke="#ea580c" stroke-width="2"/><text x="70" y="73" text-anchor="middle" font-size="12.5" font-weight="700" fill="#c2410c">[A] 4視点合成</text><text x="70" y="94" text-anchor="middle" font-size="10.5" fill="#52525b">mp_view_0..3</text><line x1="126" y1="75" x2="142" y2="75" stroke="#71717a" stroke-width="2"/><polygon points="146,75 136,70 136,80" fill="#71717a"/><rect x="146" y="42" width="112" height="66" rx="6" fill="#fff7ed" stroke="#ea580c" stroke-width="2"/><text x="202" y="73" text-anchor="middle" font-size="12.5" font-weight="700" fill="#c2410c">[B] 手作り合成</text><text x="202" y="94" text-anchor="middle" font-size="10.5" fill="#52525b">ペア順次つなぎ</text><line x1="258" y1="75" x2="274" y2="75" stroke="#71717a" stroke-width="2"/><polygon points="278,75 268,70 268,80" fill="#71717a"/><rect x="278" y="42" width="112" height="66" rx="6" fill="#fff7ed" stroke="#ea580c" stroke-width="2"/><text x="334" y="73" text-anchor="middle" font-size="12.5" font-weight="700" fill="#c2410c">[C] Stitcher</text><text x="334" y="94" text-anchor="middle" font-size="10.5" fill="#52525b">重なりSSIM比較</text><line x1="390" y1="75" x2="406" y2="75" stroke="#71717a" stroke-width="2"/><polygon points="410,75 400,70 400,80" fill="#71717a"/><rect x="410" y="42" width="112" height="66" rx="6" fill="#fff7ed" stroke="#ea580c" stroke-width="2"/><text x="466" y="73" text-anchor="middle" font-size="12.5" font-weight="700" fill="#c2410c">[D] まっすぐ化</text><text x="466" y="94" text-anchor="middle" font-size="10.5" fill="#52525b">inv(H)で復元</text><line x1="522" y1="75" x2="538" y2="75" stroke="#71717a" stroke-width="2"/><polygon points="542,75 532,70 532,80" fill="#71717a"/><rect x="542" y="42" width="112" height="66" rx="6" fill="#15803d" stroke="#15803d" stroke-width="2"/><text x="598" y="73" text-anchor="middle" font-size="12.5" font-weight="700" fill="#ffffff">[E] レポート</text><text x="598" y="94" text-anchor="middle" font-size="10.5" fill="#ffffff">JSON＋まとめ図</text></svg><figcaption><code>mini_project.py</code> の <b>5 段パイプライン</b>です。<b>[A]</b> 4 視点を合成し、<b>[B]</b> 隣接ペアを順次つないで手作りパノラマを作り、<b>[C]</b> <code>cv2.Stitcher</code> と重なり領域の SSIM で比較、<b>[D]</b> 散らかった背景に貼った平面物体を検出して逆ホモグラフィ <code>inv(H)</code> で正面へまっすぐ化し、<b>[E]</b> 全指標を <code>mp_report.json</code> とまとめ図 <code>mp_summary.png</code> に出力します。</figcaption></figure>
