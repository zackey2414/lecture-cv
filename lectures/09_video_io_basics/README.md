...
<figure class="lec-fig"><svg viewBox="0 0 660 200" role="img" aria-label="03_videowriterの処理パイプライン。readで1フレーム読み縮小し処理FPS計測しVideoWriterで再書き出し最後に読み戻して検証。途中Nフレームに1回サムネ保存" font-family="ui-sans-serif, system-ui, 'Noto Sans JP', sans-serif"><text x="330" y="26" text-anchor="middle" font-size="15" font-weight="700" fill="#c2410c">03_videowriter の処理パイプライン全体</text><rect x="16" y="50" width="104" height="46" rx="6" fill="#dbeafe" stroke="#1d4ed8" stroke-width="1.5"/><rect x="147" y="50" width="104" height="46" rx="6" fill="#dbeafe" stroke="#1d4ed8" stroke-width="1.5"/><rect x="278" y="50" width="104" height="46" rx="6" fill="#dbeafe" stroke="#1d4ed8" stroke-width="1.5"/><rect x="409" y="50" width="104" height="46" rx="6" fill="#dbeafe" stroke="#1d4ed8" stroke-width="1.5"/><rect x="540" y="50" width="104" height="46" rx="6" fill="#dbeafe" stroke="#1d4ed8" stroke-width="1.5"/><text x="68" y="71" text-anchor="middle" font-size="13" font-weight="700" fill="#18181b">read()</text><text x="68" y="88" text-anchor="middle" font-size="10.5" fill="#52525b">1 フレーム</text><text x="199" y="71" text-anchor="middle" font-size="13" font-weight="700" fill="#18181b">縮小</text><text x="199" y="88" text-anchor="middle" font-size="10.5" fill="#52525b">resize/AREA</text><text x="330" y="71" text-anchor="middle" font-size="13" font-weight="700" fill="#18181b">処理FPS計測</text><text x="330" y="88" text-anchor="middle" font-size="10.5" fill="#52525b">perf+deque</text><text x="461" y="71" text-anchor="middle" font-size="13" font-weight="700" fill="#18181b">再書き出し</text><text x="461" y="88" text-anchor="middle" font-size="10.5" fill="#52525b">VideoWriter</text><text x="592" y="71" text-anchor="middle" font-size="13" font-weight="700" fill="#18181b">読み戻し検証</text><text x="592" y="88" text-anchor="middle" font-size="10.5" fill="#52525b">メタ再確認</text><line x1="122" y1="73" x2="139" y2="73" stroke="#71717a" stroke-width="2"/><polygon points="145,73 137,68 137,78" fill="#71717a"/><line x1="253" y1="73" x2="270" y2="73" stroke="#71717a" stroke-width="2"/><polygon points="276,73 268,68 268,78" fill="#71717a"/><line x1="384" y1="73" x2="401" y2="73" stroke="#71717a" stroke-width="2"/><polygon points="407,73 399,68 399,78" fill="#71717a"/><line x1="515" y1="73" x2="532" y2="73" stroke="#71717a" stroke-width="2"/><polygon points="538,73 530,68 530,78" fill="#71717a"/><line x1="199" y1="98" x2="199" y2="126" stroke="#71717a" stroke-width="2"/><polygon points="199,132 193,122 205,122" fill="#71717a"/><text x="214" y="116" font-size="10.5" fill="#71717a">N フレームに1回</text><rect x="109" y="132" width="180" height="44" rx="6" fill="#ffedd5" stroke="#c2410c" stroke-width="1.5"/><text x="199" y="153" text-anchor="middle" font-size="12.5" font-weight="700" fill="#c2410c">サムネ連番保存</text><text x="199" y="169" text-anchor="middle" font-size="10" fill="#52525b">縮小フレームPNG</text></svg><figcaption><code>03_videowriter.py</code> の処理パイプライン全体です。<b>read() で 1 フレーム読み</b> → <b>縮小</b>（<code>resize</code> ＋ <code>INTER_AREA</code>）→ <b>処理FPS を移動平均で計測</b>（<code>perf_counter</code> ＋ <code>deque</code>）→ <b>VideoWriter で再書き出し</b> → <b>読み戻して検証</b>、という流れを 1 本にまとめます。途中で <b>N フレームに 1 回</b>だけ縮小フレームをサムネ PNG として連番保存する分岐が入ります。</figcaption></figure>
