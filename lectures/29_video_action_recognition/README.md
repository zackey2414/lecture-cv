...
<figure class="lec-fig"><svg viewBox="0 0 660 240" role="img" aria-label="画像分類の入力(N,C,H,W)に時間軸Tを足したものが行動認識の入力(N,C,T,H,W)" font-family="ui-sans-serif, system-ui, 'Noto Sans JP', sans-serif"><text x="115" y="40" text-anchor="middle" font-size="15" font-weight="700" fill="#2563eb">画像分類</text><text x="115" y="60" text-anchor="middle" font-size="12" fill="#52525b">1 枚 = 静止画</text><rect x="68" y="72" width="94" height="82" fill="#eff6ff" stroke="#2563eb" stroke-width="2"/><circle cx="115" cy="113" r="20" fill="#dbeafe" stroke="#2563eb" stroke-width="1.5"/><text x="115" y="184" text-anchor="middle" font-size="14" font-weight="700" font-family="'JetBrains Mono', monospace" fill="#18181b">(N, C, H, W)</text><text x="115" y="206" text-anchor="middle" font-size="11.5" fill="#71717a">時間軸なし</text><text x="223" y="104" text-anchor="middle" font-size="13" font-weight="700" fill="#c2410c">＋ 時間軸 T</text><line x1="180" y1="124" x2="258" y2="124" stroke="#c2410c" stroke-width="2.5"/><polygon points="266,124 256,119 256,129" fill="#c2410c"/><text x="470" y="40" text-anchor="middle" font-size="15" font-weight="700" fill="#c2410c">行動認識（本章）</text><text x="470" y="60" text-anchor="middle" font-size="12" fill="#52525b">T 枚 = クリップ</text><rect x="286" y="72" width="56" height="82" fill="#fff7ed" stroke="#ea580c" stroke-width="1.8"/><rect x="348" y="72" width="56" height="82" fill="#fff7ed" stroke="#ea580c" stroke-width="1.8"/><rect x="410" y="72" width="56" height="82" fill="#fff7ed" stroke="#ea580c" stroke-width="1.8"/><rect x="472" y="72" width="56" height="82" fill="#fff7ed" stroke="#ea580c" stroke-width="1.8"/><rect x="534" y="72" width="56" height="82" fill="#fff7ed" stroke="#ea580c" stroke-width="1.8"/><circle cx="300" cy="113" r="8" fill="#2563eb"/><circle cx="369" cy="113" r="8" fill="#2563eb"/><circle cx="438" cy="113" r="8" fill="#2563eb"/><circle cx="507" cy="113" r="8" fill="#2563eb"/><circle cx="576" cy="113" r="8" fill="#2563eb"/><line x1="286" y1="170" x2="582" y2="170" stroke="#c2410c" stroke-width="2"/><polygon points="590,170 580,165 580,175" fill="#c2410c"/><text x="438" y="190" text-anchor="middle" font-size="12" fill="#3f3f46">時間 t  →  T 枚（clip_len=16）</text><text x="438" y="214" text-anchor="middle" font-size="15" font-weight="700" font-family="'JetBrains Mono', monospace" fill="#18181b">(N, C, T, H, W)</text></svg><figcaption><b>画像分類</b>の入力は1枚ぶんの <code>(N, C, H, W)</code> ですが、<b>行動認識</b>はそこに時間軸 <b>T</b> を1つ足した <code>(N, C, T, H, W)</code> を受け取ります。<b>T</b> は1クリップのフレーム枚数（標準 <code>clip_len=16</code>）で、図のように複数フレームを時間方向に重ねたものです。行動は1枚では決まらず<b>「動き」</b>で決まるため、この時間次元こそが本章のすべての出発点です。</figcaption></figure>
...
<figure class="lec-fig"><svg viewBox="0 0 660 240" role="img" aria-label="全32フレームから8枚を選ぶ。uniformは等間隔で0,4,9,13,18,22,27,31、strideはframe_rate=4で1,5,9,13,17,21,25,29" font-family="ui-sans-serif, system-ui, 'Noto Sans JP', sans-serif"><text x="330" y="30" text-anchor="middle" font-size="14" font-weight="700" fill="#18181b">全 32 フレーム → 固定 8 枚をサンプリング</text><text x="60" y="58" font-size="13" font-weight="700" fill="#c2410c">uniform（等間隔・linspace）</text><rect x="60" y="68" width="560" height="24" fill="#f4f4f5" stroke="#d4d4d8" stroke-width="1.2"/><rect x="56" y="70" width="8" height="20" fill="#f97316"/><rect x="128" y="70" width="8" height="20" fill="#f97316"/><rect x="219" y="70" width="8" height="20" fill="#f97316"/><rect x="291" y="70" width="8" height="20" fill="#f97316"/><rect x="381" y="70" width="8" height="20" fill="#f97316"/><rect x="453" y="70" width="8" height="20" fill="#f97316"/><rect x="544" y="70" width="8" height="20" fill="#f97316"/><rect x="616" y="70" width="8" height="20" fill="#f97316"/><text x="330" y="112" text-anchor="middle" font-size="13" font-weight="700" font-family="'JetBrains Mono', monospace" fill="#c2410c">[0, 4, 9, 13, 18, 22, 27, 31]</text><text x="60" y="146" font-size="13" font-weight="700" fill="#2563eb">stride（frame_rate=4・連続）</text><rect x="60" y="156" width="560" height="24" fill="#eff6ff" stroke="#d4d4d8" stroke-width="1.2"/><rect x="74" y="158" width="8" height="20" fill="#2563eb"/><rect x="146" y="158" width="8" height="20" fill="#2563eb"/><rect x="219" y="158" width="8" height="20" fill="#2563eb"/><rect x="291" y="158" width="8" height="20" fill="#2563eb"/><rect x="363" y="158" width="8" height="20" fill="#2563eb"/><rect x="435" y="158" width="8" height="20" fill="#2563eb"/><rect x="508" y="158" width="8" height="20" fill="#2563eb"/><rect x="580" y="158" width="8" height="20" fill="#2563eb"/><text x="330" y="200" text-anchor="middle" font-size="13" font-weight="700" font-family="'JetBrains Mono', monospace" fill="#2563eb">[1, 5, 9, 13, 17, 21, 25, 29]</text><text x="330" y="226" text-anchor="middle" font-size="11.5" fill="#52525b">uniform は両端を含め均等／stride は frame_rate おきに一定間隔</text></svg><figcaption>全長 <b>32 フレーム</b>から固定で <b>8 枚</b>を選ぶ2方式です。<b>uniform（等間隔）</b>は <code>np.linspace(0, 31, 8)</code> を丸めて<b>両端を含め全体へ均等</b>に散らし <code>[0, 4, 9, 13, 18, 22, 27, 31]</code> を返します。<b>stride（clip_len + frame_rate）</b>は開始点から <b>frame_rate=4 おき</b>に連続して取り <code>[1, 5, 9, 13, 17, 21, 25, 29]</code> を返します。<b>学習時と推論時で同じ方式・同じ間隔</b>に揃えるのが鉄則です。</figcaption></figure>
...
<figure class="lec-fig"><svg viewBox="0 0 600 250" role="img" aria-label="3D畳み込みでは1つのカーネルが空間HとWに加えて時間Tの複数フレームを同時に畳み込む" font-family="ui-sans-serif, system-ui, 'Noto Sans JP', sans-serif"><text x="300" y="28" text-anchor="middle" font-size="13.5" font-weight="700" fill="#18181b">3D 畳み込み — カーネルが H×W と時間 T を同時に見る</text><rect x="144" y="48" width="110" height="110" fill="#ffffff" stroke="#d4d4d8" stroke-width="1.5"/><rect x="128" y="57" width="110" height="110" fill="#ffffff" stroke="#d4d4d8" stroke-width="1.5"/><rect x="112" y="66" width="110" height="110" fill="#ffffff" stroke="#d4d4d8" stroke-width="1.5"/><rect x="96" y="75" width="110" height="110" fill="#ffffff" stroke="#d4d4d8" stroke-width="1.5"/><rect x="80" y="84" width="110" height="110" fill="#ffffff" stroke="#c2410c" stroke-width="2"/><rect x="124" y="136" width="30" height="30" fill="#ffedd5" stroke="#dc2626" stroke-width="2"/><rect x="140" y="127" width="30" height="30" fill="#fff7ed" stroke="#dc2626" stroke-width="2"/><rect x="156" y="118" width="30" height="30" fill="#fff7ed" stroke="#dc2626" stroke-width="2"/><line x1="124" y1="136" x2="156" y2="118" stroke="#dc2626" stroke-width="1.4"/><line x1="154" y1="136" x2="186" y2="118" stroke="#dc2626" stroke-width="1.4"/><line x1="154" y1="166" x2="186" y2="148" stroke="#dc2626" stroke-width="1.4"/><line x1="124" y1="166" x2="156" y2="148" stroke="#dc2626" stroke-width="1.4"/><line x1="192" y1="80" x2="248" y2="48" stroke="#71717a" stroke-width="2"/><polygon points="256,43 244,46 250,56" fill="#71717a"/><text x="272" y="50" text-anchor="middle" font-size="12.5" font-weight="700" fill="#3f3f46">T 時間</text><line x1="70" y1="86" x2="70" y2="192" stroke="#71717a" stroke-width="1.8"/><polygon points="70,198 65,188 75,188" fill="#71717a"/><text x="56" y="142" text-anchor="middle" font-size="13" font-weight="700" fill="#3f3f46">H</text><line x1="80" y1="206" x2="184" y2="206" stroke="#71717a" stroke-width="1.8"/><polygon points="190,206 180,201 180,211" fill="#71717a"/><text x="132" y="224" text-anchor="middle" font-size="13" font-weight="700" fill="#3f3f46">W</text><line x1="356" y1="150" x2="200" y2="150" stroke="#dc2626" stroke-width="1.4" stroke-dasharray="4 3"/><polygon points="194,150 206,145 206,155" fill="#dc2626"/><text x="452" y="146" text-anchor="middle" font-size="13" font-weight="700" fill="#dc2626">3D カーネル（例 3×3×3）</text><text x="452" y="168" text-anchor="middle" font-size="11" fill="#52525b">空間×時間を同時に畳み込む</text><text x="300" y="242" text-anchor="middle" font-size="11.5" fill="#52525b">→ 受容野が時間方向にも広がり、動きを直接とらえる</text></svg><figcaption><b>3D CNN（r3d_18）</b>の中心となる演算です。画像用の 2D 畳み込みを<b>時間方向にも広げた 3D 畳み込み</b>で、1 つのカーネル（例 <code>3×3×3</code>）が<b>空間（H×W）と時間（T）の複数フレームをまとめて</b>畳み込みます。これにより<b>受容野が時間方向にも広がり</b>、静止画では捉えられない<b>動き</b>を直接特徴として取り出せます。入力 <code>(C, T, H, W)</code> をそのまま舐めるイメージです。</figcaption></figure>
...
<figure class="lec-fig"><svg viewBox="0 0 660 300" role="img" aria-label="r3d_18の手書き前処理は(T,H,W,3)uint8からフレーム選択・リサイズ・スケール・正規化・並べ替え・バッチ付与の6段で(1,3,16,112,112)にする" font-family="ui-sans-serif, system-ui, 'Noto Sans JP', sans-serif"><text x="330" y="30" text-anchor="middle" font-size="14" font-weight="700" fill="#18181b">r3d_18 手書き前処理 — (T,H,W,3) uint8 から (1,3,16,112,112) へ</text><text x="114" y="54" text-anchor="middle" font-size="12" fill="#52525b">入力: (T,H,W,3) uint8</text><text x="114" y="286" text-anchor="middle" font-size="12" font-weight="700" fill="#1d4ed8">出力: (1,3,16,112,112)</text><rect x="24" y="72" width="180" height="56" rx="8" fill="#fff7ed" stroke="#ea580c" stroke-width="2"/><rect x="240" y="72" width="180" height="56" rx="8" fill="#fff7ed" stroke="#ea580c" stroke-width="2"/><rect x="456" y="72" width="180" height="56" rx="8" fill="#fff7ed" stroke="#ea580c" stroke-width="2"/><rect x="456" y="200" width="180" height="56" rx="8" fill="#fff7ed" stroke="#ea580c" stroke-width="2"/><rect x="240" y="200" width="180" height="56" rx="8" fill="#fff7ed" stroke="#ea580c" stroke-width="2"/><rect x="24" y="200" width="180" height="56" rx="8" fill="#eff6ff" stroke="#2563eb" stroke-width="2"/><text x="114" y="98" text-anchor="middle" font-size="15" font-weight="700" fill="#c2410c">① フレーム選択</text><text x="114" y="116" text-anchor="middle" font-size="11" fill="#71717a">uniform 16枚</text><text x="330" y="98" text-anchor="middle" font-size="15" font-weight="700" fill="#c2410c">② リサイズ</text><text x="330" y="116" text-anchor="middle" font-size="11" fill="#71717a">112×112</text><text x="546" y="98" text-anchor="middle" font-size="15" font-weight="700" fill="#c2410c">③ [0,1] スケール</text><text x="546" y="116" text-anchor="middle" font-size="11" fill="#71717a">÷255</text><text x="546" y="226" text-anchor="middle" font-size="15" font-weight="700" fill="#c2410c">④ Kinetics 正規化</text><text x="546" y="244" text-anchor="middle" font-size="11" fill="#71717a">(x−mean)/std</text><text x="330" y="226" text-anchor="middle" font-size="15" font-weight="700" fill="#c2410c">⑤ 軸を並べ替え</text><text x="330" y="244" text-anchor="middle" font-size="11" fill="#71717a">permute(3,0,1,2)</text><text x="114" y="226" text-anchor="middle" font-size="15" font-weight="700" fill="#1d4ed8">⑥ バッチ次元</text><text x="114" y="244" text-anchor="middle" font-size="11" fill="#71717a">unsqueeze(0)</text><line x1="204" y1="100" x2="234" y2="100" stroke="#71717a" stroke-width="2"/><polygon points="240,100 230,95 230,105" fill="#71717a"/><line x1="420" y1="100" x2="450" y2="100" stroke="#71717a" stroke-width="2"/><polygon points="456,100 446,95 446,105" fill="#71717a"/><line x1="546" y1="128" x2="546" y2="194" stroke="#71717a" stroke-width="2"/><polygon points="546,200 541,190 551,190" fill="#71717a"/><line x1="450" y1="228" x2="426" y2="228" stroke="#71717a" stroke-width="2"/><polygon points="420,228 430,223 430,233" fill="#71717a"/><line x1="234" y1="228" x2="210" y2="228" stroke="#71717a" stroke-width="2"/><polygon points="204,228 214,223 214,233" fill="#71717a"/></svg><figcaption><code>preprocess_for_r3d</code> は <b>(T,H,W,3) の uint8 クリップ</b>を <b>(1,3,16,112,112)</b> のテンソルに整える6段の前処理です。<b>① フレーム選択</b>（uniform 16枚）→ <b>② 112×112 へリサイズ</b> → <b>③ [0,1] スケール</b>（÷255）→ <b>④ Kinetics 専用正規化</b>（mean/std）→ <b>⑤ permute で (C,T,H,W) へ並べ替え</b> → <b>⑥ バッチ次元を追加</b> の順に流れます。リサイズとスケールは線形なので順序の影響はほぼありません。<b>正規化を飛ばす・ImageNet 統計を誤用すると出力が壊れます</b>。</figcaption></figure>
...
<figure class="lec-fig"><svg viewBox="0 0 620 232" role="img" aria-label="r3d_18は(N,C,T,H,W)、VideoMAEは(N,T,C,H,W)でCとTの位置が入れ替わる" font-family="ui-sans-serif, system-ui, 'Noto Sans JP', sans-serif"><text x="310" y="30" text-anchor="middle" font-size="14" font-weight="700" fill="#18181b">同じ 5 次元でも C と T の位置が逆</text><text x="60" y="86" font-size="13" font-weight="700" fill="#3f3f46">r3d_18</text><rect x="118" y="58" width="72" height="46" fill="#f4f4f5" stroke="#71717a" stroke-width="1.6"/><rect x="198" y="58" width="72" height="46" fill="#ffedd5" stroke="#c2410c" stroke-width="2.2"/><rect x="278" y="58" width="72" height="46" fill="#dbeafe" stroke="#2563eb" stroke-width="2.2"/><rect x="358" y="58" width="72" height="46" fill="#f4f4f5" stroke="#71717a" stroke-width="1.6"/><rect x="438" y="58" width="72" height="46" fill="#f4f4f5" stroke="#71717a" stroke-width="1.6"/><text x="154" y="90" text-anchor="middle" font-size="22" font-weight="700" fill="#52525b">N</text><text x="234" y="90" text-anchor="middle" font-size="22" font-weight="700" fill="#c2410c">C</text><text x="314" y="90" text-anchor="middle" font-size="22" font-weight="700" fill="#2563eb">T</text><text x="394" y="90" text-anchor="middle" font-size="22" font-weight="700" fill="#52525b">H</text><text x="474" y="90" text-anchor="middle" font-size="22" font-weight="700" fill="#52525b">W</text><text x="52" y="168" font-size="13" font-weight="700" fill="#3f3f46">VideoMAE</text><rect x="118" y="140" width="72" height="46" fill="#f4f4f5" stroke="#71717a" stroke-width="1.6"/><rect x="198" y="140" width="72" height="46" fill="#dbeafe" stroke="#2563eb" stroke-width="2.2"/><rect x="278" y="140" width="72" height="46" fill="#ffedd5" stroke="#c2410c" stroke-width="2.2"/><rect x="358" y="140" width="72" height="46" fill="#f4f4f5" stroke="#71717a" stroke-width="1.6"/><rect x="438" y="140" width="72" height="46" fill="#f4f4f5" stroke="#71717a" stroke-width="1.6"/><text x="154" y="172" text-anchor="middle" font-size="22" font-weight="700" fill="#52525b">N</text><text x="234" y="172" text-anchor="middle" font-size="22" font-weight="700" fill="#2563eb">T</text><text x="314" y="172" text-anchor="middle" font-size="22" font-weight="700" fill="#c2410c">C</text><text x="394" y="172" text-anchor="middle" font-size="22" font-weight="700" fill="#52525b">H</text><text x="474" y="172" text-anchor="middle" font-size="22" font-weight="700" fill="#52525b">W</text><line x1="234" y1="106" x2="312" y2="138" stroke="#c2410c" stroke-width="2" stroke-dasharray="5 3"/><polygon points="314,139 303,136 308,127" fill="#c2410c"/><line x1="314" y1="106" x2="236" y2="138" stroke="#2563eb" stroke-width="2" stroke-dasharray="5 3"/><polygon points="234,139 240,127 245,136" fill="#2563eb"/><text x="540" y="122" text-anchor="middle" font-size="11.5" font-weight="700" fill="#52525b">C と T が入替</text><text x="180" y="214" text-anchor="middle" font-size="12" font-weight="700" font-family="'JetBrains Mono', monospace" fill="#18181b">r3d_18: (1,3,16,112,112)</text><text x="450" y="214" text-anchor="middle" font-size="12" font-weight="700" font-family="'JetBrains Mono', monospace" fill="#18181b">VideoMAE: (1,16,3,224,224)</text></svg><figcaption><b>r3d_18</b> と <b>VideoMAE</b> はどちらも 5 次元入力ですが、<b>C（チャンネル）と T（時間）の位置が入れ替わります</b>。r3d_18 は <b>(N, C, T, H, W)</b> = <code>(1, 3, 16, 112, 112)</code>、VideoMAE の <code>pixel_values</code> は <b>(N, T, C, H, W)</b> = <code>(1, 16, 3, 224, 224)</code>（空間サイズも 112↔224 と異なります）。<code>permute</code> の順を取り違えると<b>形は通っても中身が崩れる</b>ので、モデルごとに軸順を必ず確認します。</figcaption></figure>
...
<figure class="lec-fig"><svg viewBox="0 0 660 300" role="img" aria-label="章末ミニプロジェクトはA動画IO・B基準作り・Cサンプリング掃引・D別モデル任意・Eレポートの順に統合され必ずexit0になる" font-family="ui-sans-serif, system-ui, 'Noto Sans JP', sans-serif"><text x="330" y="34" text-anchor="middle" font-size="14" font-weight="700" fill="#18181b">ミニプロジェクト — ステージ A から E の統合パイプライン</text><rect x="24" y="80" width="180" height="56" rx="8" fill="#fff7ed" stroke="#ea580c" stroke-width="2"/><rect x="240" y="80" width="180" height="56" rx="8" fill="#fff7ed" stroke="#ea580c" stroke-width="2"/><rect x="456" y="80" width="180" height="56" rx="8" fill="#fff7ed" stroke="#ea580c" stroke-width="2"/><rect x="456" y="208" width="180" height="56" rx="8" fill="#fafafa" stroke="#71717a" stroke-width="2" stroke-dasharray="5 3"/><rect x="240" y="208" width="180" height="56" rx="8" fill="#eff6ff" stroke="#2563eb" stroke-width="2"/><text x="114" y="106" text-anchor="middle" font-size="15" font-weight="700" fill="#c2410c">A 動画 I/O</text><text x="114" y="124" text-anchor="middle" font-size="11" fill="#71717a">mp4書出→cv2読戻し</text><text x="330" y="106" text-anchor="middle" font-size="15" font-weight="700" fill="#c2410c">B 基準作り</text><text x="330" y="124" text-anchor="middle" font-size="11" fill="#71717a">top-1=pseudo-GT</text><text x="546" y="106" text-anchor="middle" font-size="15" font-weight="700" fill="#c2410c">C サンプリング掃引</text><text x="546" y="124" text-anchor="middle" font-size="11" fill="#71717a">clip_len / frame_rate</text><text x="546" y="234" text-anchor="middle" font-size="15" font-weight="700" fill="#52525b">D 別モデル(任意)</text><text x="546" y="252" text-anchor="middle" font-size="11" fill="#71717a">VideoMAE 突合</text><text x="330" y="234" text-anchor="middle" font-size="15" font-weight="700" fill="#1d4ed8">E レポート</text><text x="330" y="252" text-anchor="middle" font-size="11" fill="#71717a">掃引図＋総合json</text><text x="114" y="240" text-anchor="middle" font-size="12" fill="#71717a">※ 落ちても止めず exit 0</text><line x1="204" y1="108" x2="234" y2="108" stroke="#71717a" stroke-width="2"/><polygon points="240,108 230,103 230,113" fill="#71717a"/><line x1="420" y1="108" x2="450" y2="108" stroke="#71717a" stroke-width="2"/><polygon points="456,108 446,103 446,113" fill="#71717a"/><line x1="546" y1="136" x2="546" y2="202" stroke="#71717a" stroke-width="2"/><polygon points="546,208 541,198 551,198" fill="#71717a"/><line x1="450" y1="236" x2="426" y2="236" stroke="#71717a" stroke-width="2"/><polygon points="420,236 430,231 430,241" fill="#71717a"/></svg><figcaption><b>章末ミニプロジェクト</b>は本章の要素を1本のパイプラインに統合します。<b>A 動画 I/O</b>（合成クリップを mp4 に書き出し <code>cv2.VideoCapture</code> で読み戻す）→ <b>B 基準作り</b>（正しい前処理の top-1 を <b>pseudo-GT</b> に）→ <b>C サンプリング掃引</b>（<code>clip_len</code> 2/4/8/16・<code>frame_rate</code> 1/2/4 を変えて top-1/top-5 を測る）→ <b>D 別モデル（任意・破線）</b>（VideoMAE と突き合わせ）→ <b>E レポート</b>（掃引図＋総合 json）の順に流れます。<b>どのモデルが落ちてもパイプラインは止めず、できた範囲でレポートを出す</b>ので、必ず exit 0 になります。</figcaption></figure>
...
<figure class="lec-fig"><svg viewBox="0 0 660 300" role="img" aria-label="use_case.pyはフォルダ走査・cv2デコード・抽出と正規化・r3d_18でtopk・カタログ出力の順で検索できるタグカタログを作る" font-family="ui-sans-serif, system-ui, 'Noto Sans JP', sans-serif"><text x="330" y="34" text-anchor="middle" font-size="14" font-weight="700" fill="#18181b">use_case.py — 動画フォルダから検索できるタグ・カタログへ</text><rect x="24" y="80" width="180" height="56" rx="8" fill="#fff7ed" stroke="#ea580c" stroke-width="2"/><rect x="240" y="80" width="180" height="56" rx="8" fill="#fff7ed" stroke="#ea580c" stroke-width="2"/><rect x="456" y="80" width="180" height="56" rx="8" fill="#fff7ed" stroke="#ea580c" stroke-width="2"/><rect x="456" y="208" width="180" height="56" rx="8" fill="#fff7ed" stroke="#ea580c" stroke-width="2"/><rect x="240" y="208" width="180" height="56" rx="8" fill="#eff6ff" stroke="#2563eb" stroke-width="2"/><text x="114" y="106" text-anchor="middle" font-size="15" font-weight="700" fill="#c2410c">① フォルダ走査</text><text x="114" y="124" text-anchor="middle" font-size="11" fill="#71717a">*.mp4 / .mov 等</text><text x="330" y="106" text-anchor="middle" font-size="15" font-weight="700" fill="#c2410c">② cv2 デコード</text><text x="330" y="124" text-anchor="middle" font-size="11" fill="#71717a">VideoCapture→RGB</text><text x="546" y="106" text-anchor="middle" font-size="15" font-weight="700" fill="#c2410c">③ 抽出＋正規化</text><text x="546" y="124" text-anchor="middle" font-size="11" fill="#71717a">等間隔16枚+Kinetics</text><text x="546" y="234" text-anchor="middle" font-size="15" font-weight="700" fill="#c2410c">④ r3d_18 top-k</text><text x="546" y="252" text-anchor="middle" font-size="11" fill="#71717a">上位Nタグ</text><text x="330" y="234" text-anchor="middle" font-size="15" font-weight="700" fill="#1d4ed8">⑤ カタログ出力</text><text x="330" y="252" text-anchor="middle" font-size="11" fill="#71717a">JSON/CSV＋サムネ</text><text x="114" y="240" text-anchor="middle" font-size="12" font-weight="700" fill="#15803d">→ あとからタグで検索</text><line x1="204" y1="108" x2="234" y2="108" stroke="#71717a" stroke-width="2"/><polygon points="240,108 230,103 230,113" fill="#71717a"/><line x1="420" y1="108" x2="450" y2="108" stroke="#71717a" stroke-width="2"/><polygon points="456,108 446,103 446,113" fill="#71717a"/><line x1="546" y1="136" x2="546" y2="202" stroke="#71717a" stroke-width="2"/><polygon points="546,208 541,198 551,198" fill="#71717a"/><line x1="450" y1="236" x2="426" y2="236" stroke="#71717a" stroke-width="2"/><polygon points="420,236 430,231 430,241" fill="#71717a"/></svg><figcaption><b>同梱 <code>use_case.py</code></b> は、動画フォルダを<b>検索できるタグ・カタログ</b>に変えるパイプラインです。<b>① フォルダ走査</b>（<code>.mp4/.mov</code> 等）→ <b>② cv2 デコード</b>（<code>VideoCapture</code> で BGR→RGB）→ <b>③ 抽出＋正規化</b>（等間隔16枚＋Kinetics 統計）→ <b>④ <code>r3d_18</code> で top-k</b>（上位 N タグ）→ <b>⑤ カタログ出力</b>（<code>JSON/CSV</code> ＋サムネ一覧）の順に流れ、最後は<b>タグで横断検索</b>できる成果物になります。実写を置けばタグが意味を持ち、無ければ合成クリップで同じ経路を <code>exit 0</code> で実演します。</figcaption></figure>
