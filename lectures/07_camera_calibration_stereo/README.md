...
> Python 3.12 ／ numpy 2.4.6 ／ opencv-python-headless 4.13.0.92（`cv2` 4.13.0、calibrateCamera/StereoSGBM/stereoRectify は本体同梱・contrib 不要）／ Pillow 12.2.0 ／ matplotlib 3.10.9