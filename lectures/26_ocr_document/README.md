...
<figure class="lec-fig"><svg viewBox="0 0 660 286" role="img" aria-label="OCRの2段構造。Tesseract/EasyOCRは検出と認識の両方を行い文字列とboxとconfを返す。TrOCRは認識のみで文字列だけを返す" font-family="ui-sans-serif, system-ui, 'Noto Sans JP', sans-serif"><rect x="18" y="64" width="104" height="44" rx="6" fill="#fff7ed" stroke="#ea580c" stroke-width="1.5"/><text x="70" y="84" text-anchor="middle" font-size="13" font-weight="700" fill="#c2410c">Tesseract</text><text x="70" y="101" text-anchor="middle" font-size="13" font-weight="700" fill="#c2410c">EasyOCR</text><rect x="140" y="62" width="64" height="48" fill="#ffffff" stroke="#d4d4d8" stroke-width="1.5"/><rect x="148" y="72" width="48" height="6" fill="#d4d4d8"/><rect x="148" y="84" width="48" height="6" fill="#d4d4d8"/><rect x="148" y="96" width="48" height="6" fill="#d4d4d8"/><text x="172" y="124" text-anchor="middle" font-size="12" fill="#52525b">文書画像</text><line x1="204" y1="86" x2="232" y2="86" stroke="#71717a" stroke-width="2"/><polygon points="238,86 230,82 230,90" fill="#71717a"/><rect x="240" y="62" width="92" height="48" rx="5" fill="#ffedd5" stroke="#ea580c" stroke-width="2"/><text x="286" y="91" text-anchor="middle" font-size="15" font-weight="700" fill="#c2410c">① 検出</text><line x1="332" y1="86" x2="360" y2="86" stroke="#71717a" stroke-width="2"/><polygon points="366,86 358,82 358,90" fill="#71717a"/><rect x="368" y="62" width="92" height="48" rx="5" fill="#dbeafe" stroke="#2563eb" stroke-width="2"/><text x="414" y="91" text-anchor="middle" font-size="15" font-weight="700" fill="#1d4ed8">② 認識</text><line x1="460" y1="86" x2="488" y2="86" stroke="#71717a" stroke-width="2"/><polygon points="494,86 486,82 486,90" fill="#71717a"/><rect x="496" y="58" width="148" height="56" rx="6" fill="#fafafa" stroke="#16a34a" stroke-width="2"/><text x="570" y="82" text-anchor="middle" font-size="13" font-weight="700" fill="#15803d">文字列 + box</text><text x="570" y="101" text-anchor="middle" font-size="11.5" fill="#15803d">+ conf（座標あり）</text><line x1="14" y1="150" x2="646" y2="150" stroke="#e4e4e7" stroke-width="1"/><rect x="18" y="190" width="104" height="44" rx="6" fill="#eff6ff" stroke="#2563eb" stroke-width="1.5"/><text x="70" y="218" text-anchor="middle" font-size="15" font-weight="700" fill="#1d4ed8">TrOCR</text><rect x="140" y="188" width="64" height="48" fill="#ffffff" stroke="#d4d4d8" stroke-width="1.5"/><rect x="148" y="208" width="48" height="8" fill="#d4d4d8"/><text x="172" y="250" text-anchor="middle" font-size="12" fill="#52525b">1行画像</text><text x="282" y="200" text-anchor="middle" font-size="11" fill="#c2410c">検出①は別途必要</text><line x1="204" y1="214" x2="360" y2="214" stroke="#71717a" stroke-width="2"/><polygon points="366,214 358,210 358,218" fill="#71717a"/><rect x="368" y="188" width="92" height="48" rx="5" fill="#dbeafe" stroke="#2563eb" stroke-width="2"/><text x="414" y="210" text-anchor="middle" font-size="14" font-weight="700" fill="#1d4ed8">② 認識</text><text x="414" y="227" text-anchor="middle" font-size="11" fill="#1d4ed8">generate</text><line x1="460" y1="214" x2="488" y2="214" stroke="#71717a" stroke-width="2"/><polygon points="494,214 486,210 486,218" fill="#71717a"/><rect x="496" y="188" width="148" height="48" rx="6" fill="#fafafa" stroke="#71717a" stroke-width="2"/><text x="570" y="210" text-anchor="middle" font-size="13" font-weight="700" fill="#3f3f46">文字列のみ</text><text x="570" y="228" text-anchor="middle" font-size="11.5" fill="#52525b">（座標なし）</text></svg><figcaption>OCR は <b>① 検出（どこに文字があるか＝box）</b> と <b>② 認識（画素→文字列）</b> の2段で成り立ちます。<b>Tesseract / EasyOCR</b> は両段を担い、<b>文字列＋座標（box）＋確信度（conf）</b>を返します。一方 <b>TrOCR は ② 認識のみ</b>で、1行画像から <code>generate</code> して<b>文字列だけ</b>を返し座標は出しません（複数行は別途 ① 検出で行を切る必要があります）。</figcaption></figure>
...
<figure class="lec-fig"><svg viewBox="0 0 660 280" role="img" aria-label="TrOCRのVisionEncoderDecoder。行画像をパッチに分けViTエンコーダで符号化し、テキストデコーダがgenerateで1トークンずつ文字を生成する" font-family="ui-sans-serif, system-ui, 'Noto Sans JP', sans-serif"><text x="87" y="46" text-anchor="middle" font-size="12" fill="#52525b">行画像</text><rect x="24" y="56" width="126" height="50" fill="#ffffff" stroke="#d4d4d8" stroke-width="1.5"/><text x="87" y="88" text-anchor="middle" font-size="17" font-weight="700" fill="#18181b">Invoice 2026</text><line x1="150" y1="81" x2="178" y2="81" stroke="#71717a" stroke-width="2"/><polygon points="184,81 176,77 176,85" fill="#71717a"/><rect x="188" y="58" width="58" height="46" fill="#eff6ff" stroke="#2563eb" stroke-width="1.5"/><line x1="202.5" y1="58" x2="202.5" y2="104" stroke="#dbeafe" stroke-width="1"/><line x1="217" y1="58" x2="217" y2="104" stroke="#dbeafe" stroke-width="1"/><line x1="231.5" y1="58" x2="231.5" y2="104" stroke="#dbeafe" stroke-width="1"/><line x1="188" y1="81" x2="246" y2="81" stroke="#dbeafe" stroke-width="1"/><line x1="246" y1="81" x2="274" y2="81" stroke="#71717a" stroke-width="2"/><polygon points="280,81 272,77 272,85" fill="#71717a"/><rect x="284" y="50" width="96" height="62" rx="6" fill="#dbeafe" stroke="#2563eb" stroke-width="2"/><text x="332" y="82" text-anchor="middle" font-size="16" font-weight="700" fill="#1d4ed8">ViT</text><text x="332" y="101" text-anchor="middle" font-size="12" font-weight="600" fill="#1d4ed8">エンコーダ</text><line x1="380" y1="81" x2="410" y2="81" stroke="#71717a" stroke-width="2"/><polygon points="416,81 408,77 408,85" fill="#71717a"/><rect x="420" y="50" width="110" height="62" rx="6" fill="#ffedd5" stroke="#ea580c" stroke-width="2"/><text x="475" y="82" text-anchor="middle" font-size="15" font-weight="700" fill="#c2410c">テキスト</text><text x="475" y="101" text-anchor="middle" font-size="12" font-weight="600" fill="#c2410c">デコーダ</text><polyline points="475,112 475,150 316,150 316,176" fill="none" stroke="#ea580c" stroke-width="2"/><polygon points="316,182 311,172 321,172" fill="#ea580c"/><rect x="300" y="188" width="32" height="32" rx="4" fill="#fff7ed" stroke="#ea580c" stroke-width="1.8"/><text x="316" y="210" text-anchor="middle" font-size="16" font-weight="700" fill="#c2410c">I</text><line x1="332" y1="204" x2="344" y2="204" stroke="#71717a" stroke-width="1.8"/><polygon points="349,204 343,201 343,207" fill="#71717a"/><rect x="350" y="188" width="32" height="32" rx="4" fill="#fff7ed" stroke="#ea580c" stroke-width="1.8"/><text x="366" y="210" text-anchor="middle" font-size="16" font-weight="700" fill="#c2410c">n</text><line x1="382" y1="204" x2="394" y2="204" stroke="#71717a" stroke-width="1.8"/><polygon points="399,204 393,201 393,207" fill="#71717a"/><rect x="400" y="188" width="32" height="32" rx="4" fill="#fff7ed" stroke="#ea580c" stroke-width="1.8"/><text x="416" y="210" text-anchor="middle" font-size="16" font-weight="700" fill="#c2410c">v</text><text x="452" y="212" text-anchor="middle" font-size="18" font-weight="700" fill="#71717a">…</text><line x1="470" y1="204" x2="490" y2="204" stroke="#71717a" stroke-width="2"/><polygon points="496,204 488,200 488,208" fill="#71717a"/><rect x="500" y="188" width="142" height="34" rx="6" fill="#fafafa" stroke="#16a34a" stroke-width="2"/><text x="571" y="211" text-anchor="middle" font-size="15" font-weight="700" fill="#15803d">Invoice 2026</text><text x="380" y="248" text-anchor="middle" font-size="12" font-weight="600" fill="#c2410c">1トークンずつ自己回帰生成</text></svg><figcaption><b>TrOCR</b> は <b>VisionEncoderDecoder</b> です。行画像を小さな<b>パッチ列</b>に分け <b>ViT エンコーダ</b>で符号化し、その表現を条件に<b>テキストデコーダ</b>が <code>generate</code> で <b>1トークンずつ自己回帰</b>に文字を生成して文字列にします（機械翻訳と同じ seq2seq）。検出は行わないため <b>座標は出ません</b>。</figcaption></figure>
...
<figure class="lec-fig"><svg viewBox="0 0 640 270" role="img" aria-label="編集距離でREFとHYPを対応づけ、置換S・挿入I・削除Dを数えてCERを求める。CERは(S+D+I)/N" font-family="ui-sans-serif, system-ui, 'Noto Sans JP', sans-serif"><text x="130" y="89" text-anchor="end" font-size="13" font-weight="700" fill="#15803d">REF 正解</text><text x="130" y="147" text-anchor="end" font-size="13" font-weight="700" fill="#c2410c">HYP 予測</text><rect x="140" y="62" width="52" height="44" rx="4" fill="#f4f4f5" stroke="#d4d4d8" stroke-width="1.5"/><text x="166" y="92" text-anchor="middle" font-size="20" font-weight="700" fill="#18181b">B</text><rect x="200" y="62" width="52" height="44" rx="4" fill="#ffedd5" stroke="#ea580c" stroke-width="2"/><text x="226" y="92" text-anchor="middle" font-size="20" font-weight="700" fill="#c2410c">I</text><rect x="260" y="62" width="52" height="44" rx="4" fill="#fafafa" stroke="#71717a" stroke-width="1.5" stroke-dasharray="4 3"/><text x="286" y="92" text-anchor="middle" font-size="18" font-weight="700" fill="#71717a">∅</text><rect x="320" y="62" width="52" height="44" rx="4" fill="#f4f4f5" stroke="#d4d4d8" stroke-width="1.5"/><text x="346" y="92" text-anchor="middle" font-size="20" font-weight="700" fill="#18181b">R</text><rect x="380" y="62" width="52" height="44" rx="4" fill="#fff7ed" stroke="#dc2626" stroke-width="2"/><text x="406" y="92" text-anchor="middle" font-size="20" font-weight="700" fill="#dc2626">D</text><rect x="140" y="120" width="52" height="44" rx="4" fill="#f4f4f5" stroke="#d4d4d8" stroke-width="1.5"/><text x="166" y="150" text-anchor="middle" font-size="20" font-weight="700" fill="#18181b">B</text><rect x="200" y="120" width="52" height="44" rx="4" fill="#ffedd5" stroke="#ea580c" stroke-width="2"/><text x="226" y="150" text-anchor="middle" font-size="20" font-weight="700" fill="#c2410c">A</text><rect x="260" y="120" width="52" height="44" rx="4" fill="#dbeafe" stroke="#2563eb" stroke-width="2"/><text x="286" y="150" text-anchor="middle" font-size="20" font-weight="700" fill="#1d4ed8">X</text><rect x="320" y="120" width="52" height="44" rx="4" fill="#f4f4f5" stroke="#d4d4d8" stroke-width="1.5"/><text x="346" y="150" text-anchor="middle" font-size="20" font-weight="700" fill="#18181b">R</text><rect x="380" y="120" width="52" height="44" rx="4" fill="#fafafa" stroke="#71717a" stroke-width="1.5" stroke-dasharray="4 3"/><text x="406" y="150" text-anchor="middle" font-size="18" font-weight="700" fill="#71717a">∅</text><text x="166" y="184" text-anchor="middle" font-size="12.5" font-weight="700" fill="#71717a">一致</text><text x="226" y="184" text-anchor="middle" font-size="12.5" font-weight="700" fill="#c2410c">置換 S</text><text x="286" y="184" text-anchor="middle" font-size="12.5" font-weight="700" fill="#1d4ed8">挿入 I</text><text x="346" y="184" text-anchor="middle" font-size="12.5" font-weight="700" fill="#71717a">一致</text><text x="406" y="184" text-anchor="middle" font-size="12.5" font-weight="700" fill="#dc2626">削除 D</text><text x="320" y="226" text-anchor="middle" font-size="16" font-weight="700" fill="#18181b">CER = (S + D + I) / N = (1 + 1 + 1) / 4 = 0.75</text><text x="320" y="250" text-anchor="middle" font-size="11.5" fill="#52525b">N = 正解(REF)の文字数 = 4（B, I, R, D）</text></svg><figcaption><b>CER</b> は予測(HYP)を正解(REF)に直すのに必要な<b>編集（置換 S・削除 D・挿入 I）の最小回数＝編集距離</b>を、参照文字数 <b>N</b> で割った値です。図は <code>BIRD</code> を <code>BAXR</code> と誤読した例で、<b>I→A の置換 1</b>・<b>X の挿入 1</b>・<b>D の削除 1</b> の計 3 回。<b>CER =(S+D+I)/N = 3/4 = 0.75</b> となります（同じ関数を単語列に使えば WER）。</figcaption></figure>
...
<figure class="lec-fig"><svg viewBox="0 0 660 248" role="img" aria-label="従来は画像をOCRで文字列にしてから理解モデルに渡すためOCR誤りが伝播する。DonutはOCRフリーで画像から答えを直接生成する" font-family="ui-sans-serif, system-ui, 'Noto Sans JP', sans-serif"><rect x="18" y="54" width="92" height="48" rx="6" fill="#f4f4f5" stroke="#71717a" stroke-width="1.5"/><text x="64" y="74" text-anchor="middle" font-size="13" font-weight="700" fill="#3f3f46">従来</text><text x="64" y="92" text-anchor="middle" font-size="11" fill="#52525b">（2段）</text><rect x="128" y="54" width="58" height="48" fill="#ffffff" stroke="#d4d4d8" stroke-width="1.5"/><rect x="136" y="62" width="42" height="5" fill="#d4d4d8"/><rect x="136" y="72" width="42" height="5" fill="#d4d4d8"/><rect x="136" y="82" width="42" height="5" fill="#d4d4d8"/><rect x="136" y="92" width="42" height="5" fill="#d4d4d8"/><text x="157" y="116" text-anchor="middle" font-size="11" fill="#52525b">請求書</text><line x1="186" y1="78" x2="212" y2="78" stroke="#71717a" stroke-width="2"/><polygon points="218,78 210,74 210,82" fill="#71717a"/><rect x="220" y="54" width="96" height="48" rx="5" fill="#dbeafe" stroke="#2563eb" stroke-width="2"/><text x="268" y="74" text-anchor="middle" font-size="14" font-weight="700" fill="#1d4ed8">OCR</text><text x="268" y="92" text-anchor="middle" font-size="11" fill="#1d4ed8">テキスト</text><line x1="316" y1="78" x2="342" y2="78" stroke="#71717a" stroke-width="2"/><polygon points="348,78 340,74 340,82" fill="#71717a"/><text x="329" y="120" text-anchor="middle" font-size="10.5" font-weight="700" fill="#dc2626">誤りが伝播</text><rect x="350" y="54" width="96" height="48" rx="5" fill="#ffedd5" stroke="#ea580c" stroke-width="2"/><text x="398" y="83" text-anchor="middle" font-size="13" font-weight="700" fill="#c2410c">理解 / QA</text><line x1="446" y1="78" x2="472" y2="78" stroke="#71717a" stroke-width="2"/><polygon points="478,78 470,74 470,82" fill="#71717a"/><rect x="480" y="54" width="150" height="48" rx="6" fill="#fafafa" stroke="#16a34a" stroke-width="2"/><text x="555" y="84" text-anchor="middle" font-size="16" font-weight="700" fill="#15803d">12345</text><line x1="14" y1="130" x2="646" y2="130" stroke="#e4e4e7" stroke-width="1"/><rect x="18" y="161" width="92" height="48" rx="6" fill="#fff7ed" stroke="#ea580c" stroke-width="1.5"/><text x="64" y="181" text-anchor="middle" font-size="13" font-weight="700" fill="#c2410c">Donut</text><text x="64" y="199" text-anchor="middle" font-size="10.5" fill="#c2410c">OCRフリー</text><rect x="128" y="161" width="58" height="48" fill="#ffffff" stroke="#d4d4d8" stroke-width="1.5"/><rect x="136" y="169" width="42" height="5" fill="#d4d4d8"/><rect x="136" y="179" width="42" height="5" fill="#d4d4d8"/><rect x="136" y="189" width="42" height="5" fill="#d4d4d8"/><rect x="136" y="199" width="42" height="5" fill="#d4d4d8"/><text x="157" y="223" text-anchor="middle" font-size="11" fill="#52525b">請求書</text><line x1="186" y1="185" x2="212" y2="185" stroke="#71717a" stroke-width="2"/><polygon points="218,185 210,181 210,189" fill="#71717a"/><rect x="220" y="161" width="226" height="48" rx="6" fill="#ffedd5" stroke="#ea580c" stroke-width="2"/><text x="333" y="183" text-anchor="middle" font-size="14" font-weight="700" fill="#c2410c">Donut（1つの seq2seq）</text><text x="333" y="201" text-anchor="middle" font-size="11" fill="#c2410c">画像 → 答え を直接生成</text><line x1="446" y1="185" x2="472" y2="185" stroke="#71717a" stroke-width="2"/><polygon points="478,185 470,181 470,189" fill="#71717a"/><rect x="480" y="161" width="150" height="48" rx="6" fill="#fafafa" stroke="#16a34a" stroke-width="2"/><text x="555" y="190" text-anchor="middle" font-size="15" font-weight="700" fill="#15803d">12345 / JSON</text><text x="333" y="231" text-anchor="middle" font-size="10.5" font-weight="700" fill="#15803d">OCR を介さない＝誤り伝播なし</text></svg><figcaption>文書から答えを得る2つの道。<b>従来は2段</b>で、まず <b>OCR で文字列</b>にし、それを<b>理解モデル</b>へ渡すため <b>OCR の誤りが後段へ伝播</b>します。<b>Donut は OCR フリー</b>で、1つの seq2seq が<b>画像から答え（回答や JSON）を直接生成</b>し、途中の OCR テキストを介しません。だから<b>誤り伝播が起きず</b>、構造化出力もそのまま得られます。</figcaption></figure>
...
文書 QA の評価には、OCR と同じ exact-match だけでなく **ANLS（Average Normalized Levenshtein Similarity）**という DocVQA 標準指標を使います。ANLS は「正規化レーベンシュタイン類似度 `1 - 編集距離/max(len)`」を計算し、それが**しきい値 0.5 以上ならその値を、未満なら 0**をスコアにします。狙いは「**綴りの軽い揺れ（`Acme Corp` vs `acme corp.`）には寛容、まったく別の答えには 0 点**」という、人間の採点感覚に近い評価です。exact-match が「1文字でも違えば 0」と厳しすぎるのに対し、ANLS は**部分点**を与えます。

<figure class="lec-fig"><svg viewBox="0 0 560 280" role="img" aria-label="ANLSの採点関数。類似度NLSが0.5以上ならNLSをスコアに、0.5未満なら0点にする" font-family="ui-sans-serif, system-ui, 'Noto Sans JP', sans-serif"><line x1="80" y1="224" x2="486" y2="224" stroke="#52525b" stroke-width="2"/><polygon points="492,224 484,220 484,228" fill="#52525b"/><line x1="80" y1="224" x2="80" y2="46" stroke="#52525b" stroke-width="2"/><polygon points="80,40 76,48 84,48" fill="#52525b"/><line x1="270" y1="224" x2="270" y2="64" stroke="#71717a" stroke-width="1.5" stroke-dasharray="5 3"/><text x="270" y="58" text-anchor="middle" font-size="11" fill="#71717a">閾値</text><line x1="80" y1="224" x2="270" y2="224" stroke="#dc2626" stroke-width="3"/><line x1="270" y1="144" x2="460" y2="64" stroke="#16a34a" stroke-width="3"/><circle cx="270" cy="224" r="4.5" fill="#ffffff" stroke="#dc2626" stroke-width="2"/><circle cx="270" cy="144" r="4.5" fill="#16a34a"/><text x="76" y="240" text-anchor="end" font-size="11.5" fill="#52525b">0</text><text x="270" y="242" text-anchor="middle" font-size="11.5" fill="#52525b">0.5</text><text x="460" y="242" text-anchor="middle" font-size="11.5" fill="#52525b">1.0</text><text x="40" y="140" text-anchor="middle" font-size="13" font-weight="700" fill="#3f3f46" transform="rotate(-90 40 140)">ANLS</text><text x="285" y="266" text-anchor="middle" font-size="12" fill="#3f3f46">類似度 NLS = 1 − dist / max(len)</text><text x="170" y="205" text-anchor="middle" font-size="12.5" font-weight="700" fill="#dc2626">＜ 0.5 → 0 点</text><text x="398" y="116" text-anchor="middle" font-size="12.5" font-weight="700" fill="#15803d">≥ 0.5 → NLS を採用</text></svg><figcaption><b>ANLS</b> は文書 QA の部分点指標です。まず<b>正規化レーベンシュタイン類似度 NLS = 1 − 編集距離 / max(長さ)</b> を求め、<b>0.5 以上ならその NLS をスコアに、未満なら 0 点</b>にします。<code>Acme Corp</code> と <code>acme corp.</code> のような<b>軽い綴り揺れには寛容</b>、まったく別の答えは 0 点という、人間の採点感覚に近い評価になります。</figcaption></figure>

`03` は exact-match と ANLS の両方を出し、`ocr_helpers.anls` で実装しています（本章の合成請求書では両者とも満点でしたが、実文書では ANLS の方が実態に即した数字になります）。
...
<figure class="lec-fig"><svg viewBox="0 0 660 300" role="img" aria-label="章末ミニプロジェクトのパイプライン。合成請求書を2系統に分け、ステージAはTrOCRで認識しCER/WER、ステージBはDonutで理解しexact-match/ANLS、両者を総合レポートに統合する" font-family="ui-sans-serif, system-ui, 'Noto Sans JP', sans-serif"><text x="330" y="28" text-anchor="middle" font-size="14" font-weight="700" fill="#18181b">章末ミニプロジェクト — 認識(TrOCR) と 理解(Donut) を1本に統合</text><rect x="20" y="122" width="104" height="56" rx="8" fill="#f4f4f5" stroke="#71717a" stroke-width="2"/><text x="72" y="146" text-anchor="middle" font-size="14" font-weight="700" fill="#18181b">合成請求書</text><text x="72" y="165" text-anchor="middle" font-size="11" fill="#52525b">invoice.png</text><rect x="200" y="56" width="120" height="52" rx="6" fill="#ffedd5" stroke="#ea580c" stroke-width="2"/><text x="260" y="80" text-anchor="middle" font-size="14" font-weight="700" fill="#c2410c">A 認識</text><text x="260" y="98" text-anchor="middle" font-size="11" fill="#c2410c">TrOCR generate</text><rect x="372" y="56" width="120" height="52" rx="6" fill="#fff7ed" stroke="#f97316" stroke-width="2"/><text x="432" y="80" text-anchor="middle" font-size="15" font-weight="700" fill="#c2410c">CER / WER</text><text x="432" y="98" text-anchor="middle" font-size="11" fill="#52525b">認識誤り率</text><rect x="200" y="198" width="120" height="52" rx="6" fill="#dbeafe" stroke="#2563eb" stroke-width="2"/><text x="260" y="222" text-anchor="middle" font-size="14" font-weight="700" fill="#1d4ed8">B 理解</text><text x="260" y="240" text-anchor="middle" font-size="11" fill="#1d4ed8">Donut DocVQA</text><rect x="372" y="198" width="120" height="52" rx="6" fill="#eff6ff" stroke="#2563eb" stroke-width="2"/><text x="432" y="222" text-anchor="middle" font-size="15" font-weight="700" fill="#1d4ed8">exact / ANLS</text><text x="432" y="240" text-anchor="middle" font-size="11" fill="#52525b">文書QA採点</text><rect x="520" y="122" width="124" height="56" rx="8" fill="#fafafa" stroke="#16a34a" stroke-width="2"/><text x="582" y="146" text-anchor="middle" font-size="14" font-weight="700" fill="#15803d">総合レポート</text><text x="582" y="165" text-anchor="middle" font-size="10.5" fill="#15803d">mini_summary.png</text><line x1="124" y1="150" x2="162" y2="150" stroke="#71717a" stroke-width="2"/><line x1="162" y1="82" x2="162" y2="224" stroke="#71717a" stroke-width="2"/><line x1="162" y1="82" x2="194" y2="82" stroke="#71717a" stroke-width="2"/><polygon points="200,82 192,78 192,86" fill="#71717a"/><line x1="162" y1="224" x2="194" y2="224" stroke="#71717a" stroke-width="2"/><polygon points="200,224 192,220 192,228" fill="#71717a"/><line x1="320" y1="82" x2="366" y2="82" stroke="#71717a" stroke-width="2"/><polygon points="372,82 364,78 364,86" fill="#71717a"/><line x1="320" y1="224" x2="366" y2="224" stroke="#71717a" stroke-width="2"/><polygon points="372,224 364,220 364,228" fill="#71717a"/><line x1="492" y1="82" x2="506" y2="82" stroke="#71717a" stroke-width="2"/><line x1="492" y1="224" x2="506" y2="224" stroke="#71717a" stroke-width="2"/><line x1="506" y1="82" x2="506" y2="224" stroke="#71717a" stroke-width="2"/><line x1="506" y1="150" x2="514" y2="150" stroke="#71717a" stroke-width="2"/><polygon points="520,150 512,146 512,154" fill="#71717a"/></svg><figcaption><b>章末ミニプロジェクト</b>は、1 枚の合成請求書を 2 系統で処理して束ねます。<b>ステージA【認識】</b>はテキスト行を <b>TrOCR</b> で読み GT と比べて <b>CER/WER</b> を算出、<b>ステージB【理解】</b>は同じ請求書を <b>Donut/DocVQA</b> に渡し質問へ回答して <b>exact-match/ANLS</b> で採点します。最後に両者のスコアを「高いほど良い」に揃えた要約棒グラフ <code>mini_summary.png</code> と総合レポート <code>mini_report.json</code> に統合します。片方が落ちても残りで完走（exit 0）します。</figcaption></figure>
...
<figure class="lec-fig"><svg viewBox="0 0 660 250" role="img" aria-label="レシートリーダーの処理パイプライン。レシート画像を行検出してから各行をTrOCRで認識し正規表現で構造化してreceipt.jsonにし、同じ画像をDonutに渡し合計をクロスチェックする" font-family="ui-sans-serif, system-ui, 'Noto Sans JP', sans-serif"><text x="330" y="28" text-anchor="middle" font-size="13.5" font-weight="700" fill="#18181b">レシートリーダー — 行検出 → TrOCR → 構造化（Donut でクロスチェック）</text><rect x="14" y="56" width="104" height="52" rx="6" fill="#f4f4f5" stroke="#71717a" stroke-width="2"/><text x="66" y="80" text-anchor="middle" font-size="13" font-weight="700" fill="#18181b">レシート画像</text><text x="66" y="97" text-anchor="middle" font-size="10.5" fill="#52525b">receipt.png</text><rect x="140" y="56" width="110" height="52" rx="6" fill="#ffedd5" stroke="#ea580c" stroke-width="2"/><text x="195" y="80" text-anchor="middle" font-size="13" font-weight="700" fill="#c2410c">行検出</text><text x="195" y="97" text-anchor="middle" font-size="10.5" fill="#c2410c">射影プロファイル</text><rect x="272" y="56" width="110" height="52" rx="6" fill="#dbeafe" stroke="#2563eb" stroke-width="2"/><text x="327" y="80" text-anchor="middle" font-size="13" font-weight="700" fill="#1d4ed8">TrOCR 認識</text><text x="327" y="97" text-anchor="middle" font-size="10.5" fill="#1d4ed8">各行を文字列化</text><rect x="404" y="56" width="110" height="52" rx="6" fill="#ffedd5" stroke="#ea580c" stroke-width="2"/><text x="459" y="80" text-anchor="middle" font-size="13" font-weight="700" fill="#c2410c">構造化</text><text x="459" y="97" text-anchor="middle" font-size="10.5" fill="#c2410c">正規表現</text><rect x="536" y="92" width="110" height="56" rx="8" fill="#fafafa" stroke="#16a34a" stroke-width="2"/><text x="591" y="116" text-anchor="middle" font-size="14" font-weight="700" fill="#15803d">receipt.json</text><text x="591" y="135" text-anchor="middle" font-size="10" fill="#15803d">店名・日付・合計</text><rect x="272" y="170" width="150" height="50" rx="6" fill="#fff7ed" stroke="#ea580c" stroke-width="2"/><text x="347" y="191" text-anchor="middle" font-size="13" font-weight="700" fill="#c2410c">Donut DocVQA</text><text x="347" y="209" text-anchor="middle" font-size="10.5" fill="#c2410c">合計をクロスチェック</text><line x1="118" y1="82" x2="134" y2="82" stroke="#71717a" stroke-width="2"/><polygon points="140,82 132,78 132,86" fill="#71717a"/><line x1="250" y1="82" x2="266" y2="82" stroke="#71717a" stroke-width="2"/><polygon points="272,82 264,78 264,86" fill="#71717a"/><line x1="382" y1="82" x2="398" y2="82" stroke="#71717a" stroke-width="2"/><polygon points="404,82 396,78 396,86" fill="#71717a"/><line x1="514" y1="82" x2="525" y2="82" stroke="#71717a" stroke-width="2"/><line x1="525" y1="82" x2="525" y2="195" stroke="#71717a" stroke-width="2"/><line x1="525" y1="120" x2="530" y2="120" stroke="#71717a" stroke-width="2"/><polygon points="536,120 528,116 528,124" fill="#71717a"/><line x1="66" y1="108" x2="66" y2="195" stroke="#71717a" stroke-width="2"/><line x1="66" y1="195" x2="266" y2="195" stroke="#71717a" stroke-width="2"/><polygon points="272,195 264,191 264,199" fill="#71717a"/><line x1="422" y1="195" x2="525" y2="195" stroke="#71717a" stroke-width="2"/></svg><figcaption>実践ユースケース①の<b>レシートリーダー</b>の流れです。<b>TrOCR は認識専用で行検出を持たない</b>ため、まず<b>射影プロファイル</b>で自前の<b>行検出</b>を行い、各行を <b>TrOCR</b> で読み、<b>正規表現</b>で店名・日付・明細・合計へ<b>構造化</b>して <code>receipt.json</code> を作ります。さらに同じ画像を <b>Donut/DocVQA</b> に渡し、合計金額を <b>OCR フリーにクロスチェック</b>します。</figcaption></figure>
