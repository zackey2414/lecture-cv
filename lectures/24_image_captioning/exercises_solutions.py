"""第24回 演習の模範解答（実行すると全問 PASS する）。

このファイルは exercises.py の TODO をすべて埋めた版です。中身の解答ロジックは
exercises.py 内の _sol_exN として既に用意してあるので、ここでは
...
期待:
    全 8 問が PASS し "ALL PASS 🎉" と表示され、exit 0 で終了する。
