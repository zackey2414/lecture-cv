...
<figure class="lec-fig"><svg viewBox="0 0 660 320" role="img" aria-label="クラスタリング手法の選び方。kが分かり束が素直ならk-means、外れ値を弾き任意形状ならDBSCAN、k不要で密度の偏りに強いならAgglomerative" font-family="ui-sans-serif, system-ui, 'Noto Sans JP', sans-serif"><text x="330" y="24" text-anchor="middle" font-size="14" font-weight="700" fill="#18181b">クラスタリング手法の選び方</text><polygon points="72,80 150,38 228,80 150,122" fill="#fff7ed" stroke="#ea580c" stroke-width="2"/><polygon points="72,200 150,158 228,200 150,242" fill="#fff7ed" stroke="#ea580c" stroke-width="2"/><rect x="380" y="52" width="252" height="56" rx="8" fill="#ffedd5" stroke="#ea580c" stroke-width="2"/><rect x="380" y="172" width="252" height="56" rx="8" fill="#dbeafe" stroke="#2563eb" stroke-width="2"/><rect x="380" y="262" width="252" height="52" rx="8" fill="#ffffff" stroke="#16a34a" stroke-width="2"/><text x="150" y="75" text-anchor="middle" font-size="12.5" fill="#c2410c">k が分かる？</text><text x="150" y="93" text-anchor="middle" font-size="12.5" fill="#c2410c">束が素直？</text><text x="150" y="195" text-anchor="middle" font-size="12.5" fill="#c2410c">外れ値を弾く？</text><text x="150" y="213" text-anchor="middle" font-size="12.5" fill="#c2410c">任意形状？</text><text x="506" y="76" text-anchor="middle" font-size="15" font-weight="700" fill="#c2410c">k-means</text><text x="506" y="96" text-anchor="middle" font-size="10.5" fill="#52525b">速くて安定（大規模は MiniBatchKMeans）</text><text x="506" y="196" text-anchor="middle" font-size="15" font-weight="700" fill="#1d4ed8">DBSCAN</text><text x="506" y="216" text-anchor="middle" font-size="10.5" fill="#52525b">外れ値に強い・eps 調整がシビア</text><text x="506" y="282" text-anchor="middle" font-size="14.5" font-weight="700" fill="#15803d">Agglomerative</text><text x="506" y="302" text-anchor="middle" font-size="10.5" fill="#52525b">k 不要・しきい値で切る（最も素直）</text><text x="305" y="72" text-anchor="middle" font-size="12" font-weight="700" fill="#15803d">はい</text><text x="170" y="143" font-size="12" fill="#71717a">いいえ</text><text x="305" y="192" text-anchor="middle" font-size="12" font-weight="700" fill="#15803d">はい</text><text x="170" y="266" font-size="12" fill="#71717a">いいえ</text><line x1="230" y1="80" x2="370" y2="80" stroke="#71717a" stroke-width="2"/><polygon points="376,80 366,75 366,85" fill="#71717a"/><line x1="150" y1="124" x2="150" y2="148" stroke="#71717a" stroke-width="2"/><polygon points="150,154 145,144 155,144" fill="#71717a"/><line x1="230" y1="200" x2="370" y2="200" stroke="#71717a" stroke-width="2"/><polygon points="376,200 366,195 366,205" fill="#71717a"/><polyline points="150,244 150,288 370,288" fill="none" stroke="#71717a" stroke-width="2"/><polygon points="376,288 366,283 366,293" fill="#71717a"/></svg><figcaption><b>クラスタリング手法の選び方</b>です。<b>k が事前に分かる・束が素直</b>なら <b>k-means</b>（速くて安定、大規模は <code>MiniBatchKMeans</code>）。そうでなく<b>外れ値を弾きたい・任意形状を捉えたい</b>なら <b>DBSCAN</b>（ただし <code>eps</code> 調整がシビア）。<b>k を決めず、密度の偏りに強く</b>しきい値で切りたいなら <b>Agglomerative</b>（<code>distance_threshold</code>。本章データでは最も素直に決まる）。どの道でも<b>まず L2 正規化</b>が共通の前提です。</figcaption></figure>
...
<figure class="lec-fig"><svg viewBox="0 0 660 330" role="img" aria-label="ミニプロジェクトはStage A画像k自動選択とStage B画像AgglomerativeとStage Cテキストk-meansの3つの分析をStage Dで可視化統合しsummaryとreportを出力する" font-family="ui-sans-serif, system-ui, 'Noto Sans JP', sans-serif"><text x="330" y="32" text-anchor="middle" font-size="14" font-weight="700" fill="#18181b">ミニプロジェクト — A・B・C を D で統合・可視化</text><rect x="24" y="54" width="184" height="56" rx="8" fill="#ffedd5" stroke="#ea580c" stroke-width="2"/><rect x="24" y="137" width="184" height="56" rx="8" fill="#ffedd5" stroke="#ea580c" stroke-width="2"/><rect x="24" y="220" width="184" height="56" rx="8" fill="#ffedd5" stroke="#ea580c" stroke-width="2"/><rect x="272" y="120" width="156" height="120" rx="8" fill="#dbeafe" stroke="#2563eb" stroke-width="2"/><rect x="476" y="140" width="168" height="80" rx="8" fill="#f4f4f5" stroke="#71717a" stroke-width="2"/><text x="116" y="80" text-anchor="middle" font-size="14" font-weight="700" fill="#c2410c">Stage A・画像</text><text x="116" y="99" text-anchor="middle" font-size="11" fill="#71717a">k自動選択 → k-means</text><text x="116" y="163" text-anchor="middle" font-size="14" font-weight="700" fill="#c2410c">Stage B・画像</text><text x="116" y="182" text-anchor="middle" font-size="11" fill="#71717a">Agglomerative（k不要）</text><text x="116" y="246" text-anchor="middle" font-size="14" font-weight="700" fill="#c2410c">Stage C・テキスト</text><text x="116" y="265" text-anchor="middle" font-size="11" fill="#71717a">k-means（4トピック）</text><text x="350" y="162" text-anchor="middle" font-size="15" font-weight="700" fill="#1d4ed8">Stage D</text><text x="350" y="184" text-anchor="middle" font-size="13" font-weight="700" fill="#2563eb">可視化・統合</text><text x="350" y="206" text-anchor="middle" font-size="11" fill="#52525b">6パネル要約</text><text x="560" y="162" text-anchor="middle" font-size="11" fill="#71717a">出力</text><text x="560" y="185" text-anchor="middle" font-size="12.5" fill="#18181b">summary.png</text><text x="560" y="205" text-anchor="middle" font-size="12.5" fill="#18181b">report.json</text><line x1="208" y1="82" x2="260" y2="142" stroke="#71717a" stroke-width="2"/><polygon points="266,150 256,146 263,139" fill="#71717a"/><line x1="208" y1="165" x2="256" y2="178" stroke="#71717a" stroke-width="2"/><polygon points="266,180 255,182 258,173" fill="#71717a"/><line x1="208" y1="248" x2="258" y2="216" stroke="#71717a" stroke-width="2"/><polygon points="266,210 260,220 255,211" fill="#71717a"/><line x1="428" y1="180" x2="464" y2="180" stroke="#71717a" stroke-width="2"/><polygon points="470,180 460,175 460,185" fill="#71717a"/></svg><figcaption><b>章末ミニプロジェクト</b>の全体像です。<b>Stage A</b>（画像を k 自動選択して k-means）・<b>Stage B</b>（画像を Agglomerative で k 不要クラスタリング）・<b>Stage C</b>（テキストを k-means）という3つの分析を、<b>Stage D</b> が PCA / t-SNE で可視化・統合し、<code>mini_project_summary.png</code>（6パネル要約）と <code>mini_project_report.json</code>（全数値）に束ねます。A〜C は独立した検証、D が結果をまとめる出力ステップです。</figcaption></figure>
