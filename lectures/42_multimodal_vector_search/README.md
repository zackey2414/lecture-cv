...
<figure class="lec-fig"><svg viewBox="0 0 660 250" role="img" aria-label="CLIP埋め込みをnormalize_L2で正規化しIndexIDMapに登録してsearchで検索しwrite_indexで永続化する一本道のパイプライン" font-family="ui-sans-serif, system-ui, 'Noto Sans JP', sans-serif"><text x="330" y="28" text-anchor="middle" font-size="14" font-weight="700" fill="#18181b">埋め込み → 正規化 → index → 検索 → 永続化 の一本道</text><rect x="18" y="56" width="150" height="64" rx="8" fill="#fff7ed" stroke="#ea580c" stroke-width="2"/><text x="93" y="84" text-anchor="middle" font-size="13.5" font-weight="700" fill="#c2410c">① CLIP 埋め込み</text><text x="93" y="104" text-anchor="middle" font-size="11" fill="#52525b">(N, 512)</text><rect x="192" y="56" width="150" height="64" rx="8" fill="#fff7ed" stroke="#ea580c" stroke-width="2"/><text x="267" y="84" text-anchor="middle" font-size="13.5" font-weight="700" fill="#c2410c">② normalize_L2</text><text x="267" y="104" text-anchor="middle" font-size="11" fill="#52525b">単位ベクトル化</text><rect x="366" y="56" width="158" height="64" rx="8" fill="#eff6ff" stroke="#2563eb" stroke-width="2"/><text x="445" y="84" text-anchor="middle" font-size="13.5" font-weight="700" fill="#1d4ed8">③ index 登録</text><text x="445" y="104" text-anchor="middle" font-size="11" fill="#52525b">IndexIDMap(FlatIP)</text><rect x="546" y="56" width="100" height="64" rx="8" fill="#fafafa" stroke="#16a34a" stroke-width="2"/><text x="596" y="84" text-anchor="middle" font-size="13.5" font-weight="700" fill="#15803d">④ search</text><text x="596" y="104" text-anchor="middle" font-size="11" fill="#52525b">→ (score, ID)</text><line x1="168" y1="88" x2="186" y2="88" stroke="#71717a" stroke-width="2"/><polygon points="192,88 182,83 182,93" fill="#71717a"/><line x1="342" y1="88" x2="360" y2="88" stroke="#71717a" stroke-width="2"/><polygon points="366,88 356,83 356,93" fill="#71717a"/><line x1="524" y1="88" x2="540" y2="88" stroke="#71717a" stroke-width="2"/><polygon points="546,88 536,83 536,93" fill="#71717a"/><line x1="445" y1="120" x2="445" y2="162" stroke="#71717a" stroke-width="2"/><polygon points="445,168 440,158 450,158" fill="#71717a"/><rect x="355" y="168" width="180" height="54" rx="8" fill="#eff6ff" stroke="#2563eb" stroke-width="2"/><text x="445" y="192" text-anchor="middle" font-size="13" font-weight="700" fill="#1d4ed8">永続化（任意）</text><text x="445" y="212" text-anchor="middle" font-size="11" fill="#52525b">write/read_index + メタJSON</text></svg><figcaption>本章の FAISS は <b>① CLIP 埋め込み → ② <code>normalize_L2</code>（単位ベクトル化）→ ③ <code>IndexIDMap(IndexFlatIP)</code> に登録 → ④ <code>search</code></b> という<b>一本道</b>です。正規化で内積がコサインになり、<code>IndexIDMap</code> で各ベクトルに<b>任意ID</b>を付けられます。<code>search</code> は <b>(スコア, ID)</b> を返し、ID から別管理のメタを引きます。必要なら <b><code>write_index</code>／<code>read_index</code> ＋メタJSON</b> をセットで保存して永続化します（<code>-1</code> はメタ参照前にガード）。</figcaption></figure>
...
<figure class="lec-fig"><svg viewBox="0 0 620 310" role="img" aria-label="ミニプロジェクトのSTEP1構築からSTEP2永続化STEP3統一検索STEP4評価まで一周する流れ" font-family="ui-sans-serif, system-ui, 'Noto Sans JP', sans-serif"><text x="310" y="32" text-anchor="middle" font-size="14" font-weight="700" fill="#18181b">ミニプロジェクト — STEP1 から STEP4 までを一周</text><rect x="40" y="70" width="200" height="72" rx="8" fill="#fff7ed" stroke="#ea580c" stroke-width="2"/><text x="140" y="102" text-anchor="middle" font-size="15" font-weight="700" fill="#c2410c">STEP1 構築</text><text x="140" y="124" text-anchor="middle" font-size="11.5" fill="#52525b">CLIP で埋め込み→搭載</text><rect x="380" y="70" width="200" height="72" rx="8" fill="#eff6ff" stroke="#2563eb" stroke-width="2"/><text x="480" y="102" text-anchor="middle" font-size="15" font-weight="700" fill="#1d4ed8">STEP2 永続化</text><text x="480" y="124" text-anchor="middle" font-size="11.5" fill="#52525b">save → load で件数一致</text><rect x="380" y="200" width="200" height="72" rx="8" fill="#fff7ed" stroke="#ea580c" stroke-width="2"/><text x="480" y="232" text-anchor="middle" font-size="15" font-weight="700" fill="#c2410c">STEP3 統一検索</text><text x="480" y="254" text-anchor="middle" font-size="11.5" fill="#52525b">4方向を1つの search</text><rect x="40" y="200" width="200" height="72" rx="8" fill="#fafafa" stroke="#16a34a" stroke-width="2"/><text x="140" y="232" text-anchor="middle" font-size="15" font-weight="700" fill="#15803d">STEP4 評価</text><text x="140" y="254" text-anchor="middle" font-size="11.5" fill="#52525b">Recall@k / mAP@8</text><line x1="240" y1="106" x2="374" y2="106" stroke="#71717a" stroke-width="2"/><polygon points="380,106 370,101 370,111" fill="#71717a"/><line x1="480" y1="142" x2="480" y2="194" stroke="#71717a" stroke-width="2"/><polygon points="480,200 475,190 485,190" fill="#71717a"/><line x1="380" y1="236" x2="246" y2="236" stroke="#71717a" stroke-width="2"/><polygon points="240,236 250,231 250,241" fill="#71717a"/></svg><figcaption><b>章末ミニプロジェクト</b>は学びを end-to-end の一周に束ねます。<b>STEP1 構築</b>（画像＋テキストを CLIP で埋め込み <code>MultimodalSearchEngine</code> に搭載）→ <b>STEP2 永続化</b>（<code>.faiss</code>＋<code>.meta.json</code> を保存し <code>load()</code> で読み戻して件数一致を確認）→ <b>STEP3 統一検索</b>（4方向を1つの <code>search()</code> で実行）→ <b>STEP4 評価</b>（<code>Recall@k</code>／<code>mAP@8</code> を計測）の順に進みます。</figcaption></figure>
